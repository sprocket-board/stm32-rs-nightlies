...
pub mod plli2scfgr;
#[doc = "PLLSAICFGR (rw) register accessor: an alias for `Reg<PLLSAICFGR_SPEC>`"]
pub type PLLSAICFGR = crate::Reg<pllsaicfgr::PLLSAICFGR_SPEC>;
#[doc = "PLL configuration register"]
pub mod pllsaicfgr;
#[doc = "DCKCFGR (rw) register accessor: an alias for `Reg<DCKCFGR_SPEC>`"]
pub type DCKCFGR = crate::Reg<dckcfgr::DCKCFGR_SPEC>;
#[doc = "Dedicated Clock Configuration Register"]
pub mod dckcfgr;
#[doc = "CKGATENR (rw) register accessor: an alias for `Reg<CKGATENR_SPEC>`"]
pub type CKGATENR = crate::Reg<ckgatenr::CKGATENR_SPEC>;
#[doc = "clocks gated enable register"]
pub mod ckgatenr;
#[doc = "DCKCFGR2 (rw) register accessor: an alias for `Reg<DCKCFGR2_SPEC>`"]
