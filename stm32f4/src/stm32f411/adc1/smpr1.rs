...
pub type SMP18_R = crate::FieldReader<u8, SMPX_X_A>;
...
impl SMP18_R {
    ...
    pub fn variant(&self) -> SMPX_X_A {
        match self.bits {
            ...
            3 => SMPX_X_A::Cycles56,
            4 => SMPX_X_A::Cycles84,
            5 => SMPX_X_A::Cycles112,
            6 => SMPX_X_A::Cycles144,
            7 => SMPX_X_A::Cycles480,
            _ => unreachable!(),
        }
    }
...
pub type SMP18_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, SMPR1_SPEC, u8, SMPX_X_A, 3, O>;
