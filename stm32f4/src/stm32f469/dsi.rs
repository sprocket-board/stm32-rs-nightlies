...
#[doc = "VR (rw) register accessor: an alias for `Reg<VR_SPEC>`"]
...
pub mod gpdr;
#[doc = "GPSR (rw) register accessor: an alias for `Reg<GPSR_SPEC>`"]
...
pub mod tccr5;
#[doc = "TCCR6 (rw) register accessor: an alias for `Reg<TCCR6_SPEC>`"]
...
pub mod pctlr;
#[doc = "PCCONFR (rw) register accessor: an alias for `Reg<PCCONFR_SPEC>`"]
...
pub mod ier1;
#[doc = "FIR0 (rw) register accessor: an alias for `Reg<FIR0_SPEC>`"]
pub type FIR0 = crate::Reg<fir0::FIR0_SPEC>;
#[doc = "DSI Host Force Interrupt Register 0"]
pub mod fir0;
#[doc = "FIR1 (rw) register accessor: an alias for `Reg<FIR1_SPEC>`"]
...
#[doc = "DSI_WPCR4"]
pub mod wpcr4;
#[doc = "WPCR5 (rw) register accessor: an alias for `Reg<WPCR5_SPEC>`"]
