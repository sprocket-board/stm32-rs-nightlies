...
pub mod doutr;
#[doc = "KEYR0 (w) register accessor: an alias for `Reg<KEYR0_SPEC>`"]
pub type KEYR0 = crate::Reg<keyr0::KEYR0_SPEC>;
#[doc = "key register 0"]
pub mod keyr0;
#[doc = "KEYR1 (w) register accessor: an alias for `Reg<KEYR1_SPEC>`"]
pub type KEYR1 = crate::Reg<keyr1::KEYR1_SPEC>;
#[doc = "key register 1"]
pub mod keyr1;
#[doc = "KEYR2 (w) register accessor: an alias for `Reg<KEYR2_SPEC>`"]
pub type KEYR2 = crate::Reg<keyr2::KEYR2_SPEC>;
#[doc = "key register 2"]
pub mod keyr2;
#[doc = "KEYR3 (w) register accessor: an alias for `Reg<KEYR3_SPEC>`"]
...
pub mod ivr3;
#[doc = "KEYR4 (w) register accessor: an alias for `Reg<KEYR4_SPEC>`"]
pub type KEYR4 = crate::Reg<keyr4::KEYR4_SPEC>;
#[doc = "key register 4"]
pub mod keyr4;
#[doc = "KEYR5 (w) register accessor: an alias for `Reg<KEYR5_SPEC>`"]
pub type KEYR5 = crate::Reg<keyr5::KEYR5_SPEC>;
#[doc = "key register 5"]
pub mod keyr5;
#[doc = "KEYR6 (w) register accessor: an alias for `Reg<KEYR6_SPEC>`"]
pub type KEYR6 = crate::Reg<keyr6::KEYR6_SPEC>;
#[doc = "key register 6"]
pub mod keyr6;
#[doc = "KEYR7 (w) register accessor: an alias for `Reg<KEYR7_SPEC>`"]
