...
pub type TOCAL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OTG_HS_GUSBCFG_SPEC, u8, u8, 3, O>;
#[doc = "Field `PHYSEL` writer - USB 2.0 high-speed ULPI PHY or USB 1.1 full-speed serial transceiver select"]
pub type PHYSEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_HS_GUSBCFG_SPEC, bool, O>;
#[doc = "Field `SRPCAP` reader - SRP-capable"]
pub type SRPCAP_R = crate::BitReader<bool>;
#[doc = "Field `SRPCAP` writer - SRP-capable"]
pub type SRPCAP_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_HS_GUSBCFG_SPEC, bool, O>;
#[doc = "Field `HNPCAP` reader - HNP-capable"]
pub type HNPCAP_R = crate::BitReader<bool>;
#[doc = "Field `HNPCAP` writer - HNP-capable"]
pub type HNPCAP_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_HS_GUSBCFG_SPEC, bool, O>;
...
pub type TRDT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OTG_HS_GUSBCFG_SPEC, u8, u8, 4, O>;
...
pub type PHYLPCS_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_HS_GUSBCFG_SPEC, bool, O>;
...
pub type ULPIFSLS_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_HS_GUSBCFG_SPEC, bool, O>;
#[doc = "Field `ULPIAR` reader - ULPI Auto-resume"]
pub type ULPIAR_R = crate::BitReader<bool>;
#[doc = "Field `ULPIAR` writer - ULPI Auto-resume"]
pub type ULPIAR_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_HS_GUSBCFG_SPEC, bool, O>;
...
pub type ULPICSM_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_HS_GUSBCFG_SPEC, bool, O>;
...
pub type ULPIEVBUSD_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_HS_GUSBCFG_SPEC, bool, O>;
...
pub type ULPIEVBUSI_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_HS_GUSBCFG_SPEC, bool, O>;
...
pub type TSDPS_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_HS_GUSBCFG_SPEC, bool, O>;
#[doc = "Field `PCCI` reader - Indicator complement"]
pub type PCCI_R = crate::BitReader<bool>;
#[doc = "Field `PCCI` writer - Indicator complement"]
pub type PCCI_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_HS_GUSBCFG_SPEC, bool, O>;
...
pub type PTCI_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_HS_GUSBCFG_SPEC, bool, O>;
...
pub type ULPIIPD_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_HS_GUSBCFG_SPEC, bool, O>;
#[doc = "Field `FHMOD` reader - Forced host mode"]
pub type FHMOD_R = crate::BitReader<bool>;
#[doc = "Field `FHMOD` writer - Forced host mode"]
pub type FHMOD_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_HS_GUSBCFG_SPEC, bool, O>;
...
pub type FDMOD_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_HS_GUSBCFG_SPEC, bool, O>;
#[doc = "Field `CTXPKT` reader - Corrupt Tx packet"]
pub type CTXPKT_R = crate::BitReader<bool>;
#[doc = "Field `CTXPKT` writer - Corrupt Tx packet"]
pub type CTXPKT_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_HS_GUSBCFG_SPEC, bool, O>;
impl R {
