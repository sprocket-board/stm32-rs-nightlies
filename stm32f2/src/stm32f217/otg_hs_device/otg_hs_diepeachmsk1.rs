...
pub type INEPNMM_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_HS_DIEPEACHMSK1_SPEC, bool, O>;
...
pub type BIM_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_HS_DIEPEACHMSK1_SPEC, bool, O>;
