...
pub mod opamp1_otr;
#[doc = "OPAMP1_LPOTR (rw) register accessor: an alias for `Reg<OPAMP1_LPOTR_SPEC>`"]
...
#[doc = "OPAMP2_CRS (rw) register accessor: an alias for `Reg<OPAMP2_CRS_SPEC>`"]
...
pub mod opamp2_otr;
#[doc = "OPAMP2_LPOTR (rw) register accessor: an alias for `Reg<OPAMP2_LPOTR_SPEC>`"]
