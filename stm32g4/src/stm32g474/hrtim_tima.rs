...
pub mod timaicr;
#[doc = "TIMADIER (rw) register accessor: an alias for `Reg<TIMADIER_SPEC>`"]
...
pub mod fltar;
#[doc = "TIMACR2 (rw) register accessor: an alias for `Reg<TIMACR2_SPEC>`"]
pub type TIMACR2 = crate::Reg<timacr2::TIMACR2_SPEC>;
#[doc = "HRTIM Timerx Control Register 2"]
pub mod timacr2;
#[doc = "AEEFR3 (rw) register accessor: an alias for `Reg<AEEFR3_SPEC>`"]
