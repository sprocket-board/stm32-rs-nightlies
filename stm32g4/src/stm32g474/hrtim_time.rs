...
pub mod timeicr;
#[doc = "TIMEDIER (rw) register accessor: an alias for `Reg<TIMEDIER_SPEC>`"]
...
pub mod flter;
#[doc = "TIMECR2 (rw) register accessor: an alias for `Reg<TIMECR2_SPEC>`"]
pub type TIMECR2 = crate::Reg<timecr2::TIMECR2_SPEC>;
#[doc = "HRTIM Timerx Control Register 2"]
pub mod timecr2;
#[doc = "EEEFR3 (rw) register accessor: an alias for `Reg<EEEFR3_SPEC>`"]
