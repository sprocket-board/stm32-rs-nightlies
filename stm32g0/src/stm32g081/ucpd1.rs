...
pub mod rx_ordset;
#[doc = "RX_PAYSZ (rw) register accessor: an alias for `Reg<RX_PAYSZ_SPEC>`"]
...
#[doc = "UCPD Rx Ordered Set Extension Register"]
pub mod rx_ordext2;
#[doc = "IPVER (r) register accessor: an alias for `Reg<IPVER_SPEC>`"]
pub type IPVER = crate::Reg<ipver::IPVER_SPEC>;
#[doc = "UCPD IP ID register"]
pub mod ipver;
#[doc = "IPID (r) register accessor: an alias for `Reg<IPID_SPEC>`"]
pub type IPID = crate::Reg<ipid::IPID_SPEC>;
#[doc = "UCPD IP ID register"]
pub mod ipid;
#[doc = "MID (r) register accessor: an alias for `Reg<MID_SPEC>`"]
