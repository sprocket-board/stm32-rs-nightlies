...
pub type STAT_TX_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, EPR_SPEC, u8, STAT_TX_A, 2, O>;
...
pub type DTOG_TX_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPR_SPEC, bool, O>;
...
pub type CTR_TX_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPR_SPEC, bool, O>;
...
pub type STAT_RX_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, EPR_SPEC, u8, STAT_RX_A, 2, O>;
...
pub type DTOG_RX_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPR_SPEC, bool, O>;
...
pub type CTR_RX_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPR_SPEC, bool, O>;
impl R {
