...
pub mod cr1;
#[doc = "CSR1 (r) register accessor: an alias for `Reg<CSR1_SPEC>`"]
...
pub mod cr3;
#[doc = "CPUCR (rw) register accessor: an alias for `Reg<CPUCR_SPEC>`"]
pub type CPUCR = crate::Reg<cpucr::CPUCR_SPEC>;
#[doc = "This register allows controlling CPU1 power."]
pub mod cpucr;
#[doc = "SRDCR (rw) register accessor: an alias for `Reg<SRDCR_SPEC>`"]
...
pub mod srdcr;
#[doc = "WKUPCR (rw) register accessor: an alias for `Reg<WKUPCR_SPEC>`"]
...
pub mod wkupcr;
#[doc = "WKUPFR (rw) register accessor: an alias for `Reg<WKUPFR_SPEC>`"]
pub type WKUPFR = crate::Reg<wkupfr::WKUPFR_SPEC>;
#[doc = "reset only by system reset, not reset by wakeup from Standby mode"]
pub mod wkupfr;
#[doc = "WKUPEPR (rw) register accessor: an alias for `Reg<WKUPEPR_SPEC>`"]
