...
#[doc = "EXTI D3 pending clear selection register high"]
pub mod d3pcr3h;
#[doc = "CPUIMR1 (rw) register accessor: an alias for `Reg<CPUIMR1_SPEC>`"]
pub type CPUIMR1 = crate::Reg<cpuimr1::CPUIMR1_SPEC>;
#[doc = "EXTI interrupt mask register"]
pub mod cpuimr1;
#[doc = "CPUEMR1 (rw) register accessor: an alias for `Reg<CPUEMR1_SPEC>`"]
pub type CPUEMR1 = crate::Reg<cpuemr1::CPUEMR1_SPEC>;
#[doc = "EXTI event mask register"]
pub mod cpuemr1;
#[doc = "CPUPR1 (rw) register accessor: an alias for `Reg<CPUPR1_SPEC>`"]
pub type CPUPR1 = crate::Reg<cpupr1::CPUPR1_SPEC>;
#[doc = "EXTI pending register"]
pub mod cpupr1;
#[doc = "CPUIMR2 (rw) register accessor: an alias for `Reg<CPUIMR2_SPEC>`"]
pub type CPUIMR2 = crate::Reg<cpuimr2::CPUIMR2_SPEC>;
#[doc = "EXTI interrupt mask register"]
pub mod cpuimr2;
#[doc = "CPUEMR2 (rw) register accessor: an alias for `Reg<CPUEMR2_SPEC>`"]
pub type CPUEMR2 = crate::Reg<cpuemr2::CPUEMR2_SPEC>;
#[doc = "EXTI event mask register"]
pub mod cpuemr2;
#[doc = "CPUPR2 (rw) register accessor: an alias for `Reg<CPUPR2_SPEC>`"]
pub type CPUPR2 = crate::Reg<cpupr2::CPUPR2_SPEC>;
#[doc = "EXTI pending register"]
pub mod cpupr2;
#[doc = "CPUIMR3 (rw) register accessor: an alias for `Reg<CPUIMR3_SPEC>`"]
pub type CPUIMR3 = crate::Reg<cpuimr3::CPUIMR3_SPEC>;
#[doc = "EXTI interrupt mask register"]
pub mod cpuimr3;
#[doc = "CPUEMR3 (rw) register accessor: an alias for `Reg<CPUEMR3_SPEC>`"]
pub type CPUEMR3 = crate::Reg<cpuemr3::CPUEMR3_SPEC>;
#[doc = "EXTI event mask register"]
pub mod cpuemr3;
#[doc = "CPUPR3 (rw) register accessor: an alias for `Reg<CPUPR3_SPEC>`"]
