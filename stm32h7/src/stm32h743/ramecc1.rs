...
pub mod m4sr;
#[doc = "M4FAR (rw) register accessor: an alias for `Reg<M4FAR_SPEC>`"]
...
pub mod m4fdrl;
#[doc = "M4FDRH (rw) register accessor: an alias for `Reg<M4FDRH_SPEC>`"]
pub type M4FDRH = crate::Reg<m4fdrh::M4FDRH_SPEC>;
#[doc = "RAMECC monitor 4 failing data high register"]
pub mod m4fdrh;
#[doc = "M4FECR (rw) register accessor: an alias for `Reg<M4FECR_SPEC>`"]
