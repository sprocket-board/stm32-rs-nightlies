...
pub mod dmasbmr;
#[doc = "DMAISR (rw) register accessor: an alias for `Reg<DMAISR_SPEC>`"]
pub type DMAISR = crate::Reg<dmaisr::DMAISR_SPEC>;
#[doc = "Interrupt status register"]
pub mod dmaisr;
#[doc = "DMADSR (rw) register accessor: an alias for `Reg<DMADSR_SPEC>`"]
...
pub mod dmacsr;
#[doc = "DMACMFCR (rw) register accessor: an alias for `Reg<DMACMFCR_SPEC>`"]
