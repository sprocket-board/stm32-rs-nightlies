...
pub mod smpr2;
#[doc = "LTR1 (rw) register accessor: an alias for `Reg<LTR1_SPEC>`"]
pub type LTR1 = crate::Reg<ltr1::LTR1_SPEC>;
#[doc = "ADC analog watchdog 1 threshold register"]
pub mod ltr1;
#[doc = "HTR1 (rw) register accessor: an alias for `Reg<HTR1_SPEC>`"]
