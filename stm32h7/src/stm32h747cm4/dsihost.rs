...
pub mod psr;
#[doc = "ISR0 (rw) register accessor: an alias for `Reg<ISR0_SPEC>`"]
pub type ISR0 = crate::Reg<isr0::ISR0_SPEC>;
#[doc = "DSI Host interrupt and status register 0"]
pub mod isr0;
#[doc = "ISR1 (rw) register accessor: an alias for `Reg<ISR1_SPEC>`"]
...
pub mod vvsaccr;
#[doc = "VVPBCCR (rw) register accessor: an alias for `Reg<VVPBCCR_SPEC>`"]
...
pub mod wier;
#[doc = "WISR (rw) register accessor: an alias for `Reg<WISR_SPEC>`"]
