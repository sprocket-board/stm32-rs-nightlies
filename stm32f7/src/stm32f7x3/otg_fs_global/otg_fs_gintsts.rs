...
pub type MMIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_FS_GINTSTS_SPEC, bool, O>;
...
pub type SOF_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_FS_GINTSTS_SPEC, bool, O>;
...
pub type ESUSP_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_FS_GINTSTS_SPEC, bool, O>;
#[doc = "Field `USBSUSP` reader - USB suspend"]
pub type USBSUSP_R = crate::BitReader<bool>;
#[doc = "Field `USBSUSP` writer - USB suspend"]
pub type USBSUSP_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_FS_GINTSTS_SPEC, bool, O>;
#[doc = "Field `USBRST` reader - USB reset"]
pub type USBRST_R = crate::BitReader<bool>;
#[doc = "Field `USBRST` writer - USB reset"]
pub type USBRST_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_FS_GINTSTS_SPEC, bool, O>;
...
pub type ENUMDNE_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_FS_GINTSTS_SPEC, bool, O>;
...
pub type ISOODRP_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_FS_GINTSTS_SPEC, bool, O>;
...
pub type EOPF_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_FS_GINTSTS_SPEC, bool, O>;
...
pub type IISOIXFR_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_FS_GINTSTS_SPEC, bool, O>;
...
pub type IPXFR_INCOMPISOOUT_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, OTG_FS_GINTSTS_SPEC, bool, O>;
...
pub type RSTDET_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_FS_GINTSTS_SPEC, bool, O>;
...
pub type CIDSCHG_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_FS_GINTSTS_SPEC, bool, O>;
...
pub type DISCINT_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_FS_GINTSTS_SPEC, bool, O>;
...
pub type SRQINT_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_FS_GINTSTS_SPEC, bool, O>;
...
pub type WKUPINT_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_FS_GINTSTS_SPEC, bool, O>;
impl R {
