...
pub type IEP1INT_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_HS_DEACHINT_SPEC, bool, O>;
...
pub type OEP1INT_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_HS_DEACHINT_SPEC, bool, O>;
impl R {
