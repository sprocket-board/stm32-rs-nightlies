...
pub type IEP1INTM_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_HS_DEACHINTMSK_SPEC, bool, O>;
...
pub type OEP1INTM_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_HS_DEACHINTMSK_SPEC, bool, O>;
impl R {
