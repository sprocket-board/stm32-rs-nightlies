...
#[doc = "OTG_HS_HNPTXSTS (r) register accessor: an alias for `Reg<OTG_HS_HNPTXSTS_SPEC>`"]
...
#[doc = "OTG_HS_GI2CCTL (rw) register accessor: an alias for `Reg<OTG_HS_GI2CCTL_SPEC>`"]
