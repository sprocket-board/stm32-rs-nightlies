...
pub type STPPCLK_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_FS_PCGCCTL_SPEC, bool, O>;
#[doc = "Field `GATEHCLK` reader - Gate HCLK"]
pub type GATEHCLK_R = crate::BitReader<bool>;
#[doc = "Field `GATEHCLK` writer - Gate HCLK"]
pub type GATEHCLK_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_FS_PCGCCTL_SPEC, bool, O>;
#[doc = "Field `PHYSUSP` reader - PHY Suspended"]
pub type PHYSUSP_R = crate::BitReader<bool>;
#[doc = "Field `PHYSUSP` writer - PHY Suspended"]
pub type PHYSUSP_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_FS_PCGCCTL_SPEC, bool, O>;
impl R {
