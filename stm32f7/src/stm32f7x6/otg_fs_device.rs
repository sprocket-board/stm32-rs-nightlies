...
#[doc = "OTG_FS_DIEPTSIZ55 (rw) register accessor: an alias for `Reg<OTG_FS_DIEPTSIZ55_SPEC>`"]
...
#[doc = "OTG_FS_DTXFSTS55 (rw) register accessor: an alias for `Reg<OTG_FS_DTXFSTS55_SPEC>`"]
