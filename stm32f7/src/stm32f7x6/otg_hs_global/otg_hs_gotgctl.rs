...
pub type SRQ_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_HS_GOTGCTL_SPEC, bool, O>;
...
pub type HNPRQ_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_HS_GOTGCTL_SPEC, bool, O>;
...
pub type HSHNPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_HS_GOTGCTL_SPEC, bool, O>;
...
pub type DHNPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_HS_GOTGCTL_SPEC, bool, O>;
#[doc = "Field `EHEN` reader - Embedded host enable"]
pub type EHEN_R = crate::BitReader<bool>;
#[doc = "Field `EHEN` writer - Embedded host enable"]
pub type EHEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_HS_GOTGCTL_SPEC, bool, O>;
