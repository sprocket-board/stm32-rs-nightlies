...
pub type COMPLSPLT_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_HS_HCSPLT15_SPEC, bool, O>;
#[doc = "Field `SPLITEN` reader - Split enable"]
pub type SPLITEN_R = crate::BitReader<bool>;
#[doc = "Field `SPLITEN` writer - Split enable"]
pub type SPLITEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_HS_HCSPLT15_SPEC, bool, O>;
impl R {
