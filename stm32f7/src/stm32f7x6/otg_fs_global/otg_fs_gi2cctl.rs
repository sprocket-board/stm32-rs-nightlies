...
pub type RWDATA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OTG_FS_GI2CCTL_SPEC, u8, u8, 8, O>;
...
pub type I2CDEVADR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, OTG_FS_GI2CCTL_SPEC, u8, u8, 2, O>;
...
pub type I2CDATSE0_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_FS_GI2CCTL_SPEC, bool, O>;
#[doc = "Field `RW` reader - Read/Write Indicator"]
pub type RW_R = crate::BitReader<bool>;
#[doc = "Field `RW` writer - Read/Write Indicator"]
pub type RW_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_FS_GI2CCTL_SPEC, bool, O>;
#[doc = "Field `BSYDNE` reader - I2C Busy/Done"]
pub type BSYDNE_R = crate::BitReader<bool>;
#[doc = "Field `BSYDNE` writer - I2C Busy/Done"]
pub type BSYDNE_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_FS_GI2CCTL_SPEC, bool, O>;
impl R {
