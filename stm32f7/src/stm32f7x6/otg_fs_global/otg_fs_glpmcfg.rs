...
pub type LPMEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_FS_GLPMCFG_SPEC, bool, O>;
...
pub type LPMACK_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_FS_GLPMCFG_SPEC, bool, O>;
...
pub type BESL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OTG_FS_GLPMCFG_SPEC, u8, u8, 4, O>;
...
pub type REMWAKE_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_FS_GLPMCFG_SPEC, bool, O>;
...
pub type L1SSEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_FS_GLPMCFG_SPEC, bool, O>;
...
pub type BESLTHRS_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, OTG_FS_GLPMCFG_SPEC, u8, u8, 4, O>;
...
pub type L1DSEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_FS_GLPMCFG_SPEC, bool, O>;
...
pub type LPMCHIDX_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, OTG_FS_GLPMCFG_SPEC, u8, u8, 4, O>;
...
pub type LPMRCNT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, OTG_FS_GLPMCFG_SPEC, u8, u8, 3, O>;
...
pub type SNDLPM_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_FS_GLPMCFG_SPEC, bool, O>;
...
pub type ENBESL_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_FS_GLPMCFG_SPEC, bool, O>;
impl R {
