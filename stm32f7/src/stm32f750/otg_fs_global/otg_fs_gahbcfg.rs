...
pub type GINT_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_FS_GAHBCFG_SPEC, bool, O>;
...
pub type TXFELVL_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_FS_GAHBCFG_SPEC, bool, O>;
...
pub type PTXFELVL_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_FS_GAHBCFG_SPEC, bool, O>;
impl R {
