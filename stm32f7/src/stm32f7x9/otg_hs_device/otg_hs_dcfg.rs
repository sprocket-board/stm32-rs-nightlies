...
pub type DSPD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OTG_HS_DCFG_SPEC, u8, u8, 2, O>;
...
pub type NZLSOHSK_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_HS_DCFG_SPEC, bool, O>;
#[doc = "Field `DAD` reader - Device address"]
pub type DAD_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DAD` writer - Device address"]
pub type DAD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OTG_HS_DCFG_SPEC, u8, u8, 7, O>;
...
pub type PFIVL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OTG_HS_DCFG_SPEC, u8, u8, 2, O>;
...
pub type PERSCHIVL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OTG_HS_DCFG_SPEC, u8, u8, 2, O>;
impl R {
