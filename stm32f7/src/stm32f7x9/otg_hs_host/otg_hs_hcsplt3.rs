...
pub type PRTADDR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, OTG_HS_HCSPLT3_SPEC, u8, u8, 7, O>;
...
pub type XACTPOS_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, OTG_HS_HCSPLT3_SPEC, u8, u8, 2, O>;
...
pub type COMPLSPLT_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_HS_HCSPLT3_SPEC, bool, O>;
#[doc = "Field `SPLITEN` reader - Split enable"]
pub type SPLITEN_R = crate::BitReader<bool>;
#[doc = "Field `SPLITEN` writer - Split enable"]
pub type SPLITEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_HS_HCSPLT3_SPEC, bool, O>;
impl R {
