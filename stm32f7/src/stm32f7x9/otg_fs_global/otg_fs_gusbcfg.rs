...
pub type TOCAL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OTG_FS_GUSBCFG_SPEC, u8, u8, 3, O>;
#[doc = "Field `PHYSEL` writer - Full Speed serial transceiver select"]
pub type PHYSEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_FS_GUSBCFG_SPEC, bool, O>;
#[doc = "Field `SRPCAP` reader - SRP-capable"]
pub type SRPCAP_R = crate::BitReader<bool>;
#[doc = "Field `SRPCAP` writer - SRP-capable"]
pub type SRPCAP_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_FS_GUSBCFG_SPEC, bool, O>;
#[doc = "Field `HNPCAP` reader - HNP-capable"]
pub type HNPCAP_R = crate::BitReader<bool>;
#[doc = "Field `HNPCAP` writer - HNP-capable"]
pub type HNPCAP_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_FS_GUSBCFG_SPEC, bool, O>;
...
pub type TRDT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OTG_FS_GUSBCFG_SPEC, u8, u8, 4, O>;
#[doc = "Field `FHMOD` reader - Force host mode"]
pub type FHMOD_R = crate::BitReader<bool>;
#[doc = "Field `FHMOD` writer - Force host mode"]
pub type FHMOD_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_FS_GUSBCFG_SPEC, bool, O>;
#[doc = "Field `FDMOD` reader - Force device mode"]
pub type FDMOD_R = crate::BitReader<bool>;
#[doc = "Field `FDMOD` writer - Force device mode"]
pub type FDMOD_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_FS_GUSBCFG_SPEC, bool, O>;
impl R {
