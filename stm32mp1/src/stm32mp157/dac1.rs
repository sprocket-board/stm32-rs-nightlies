...
pub mod dac_shrr;
#[doc = "DAC_HWCFGR0 (r) register accessor: an alias for `Reg<DAC_HWCFGR0_SPEC>`"]
pub type DAC_HWCFGR0 = crate::Reg<dac_hwcfgr0::DAC_HWCFGR0_SPEC>;
#[doc = "DAC IP hardware configuration register"]
pub mod dac_hwcfgr0;
#[doc = "DAC_VERR (r) register accessor: an alias for `Reg<DAC_VERR_SPEC>`"]
pub type DAC_VERR = crate::Reg<dac_verr::DAC_VERR_SPEC>;
#[doc = "No"]
pub mod dac_verr;
#[doc = "DAC_IPIDR (r) register accessor: an alias for `Reg<DAC_IPIDR_SPEC>`"]
pub type DAC_IPIDR = crate::Reg<dac_ipidr::DAC_IPIDR_SPEC>;
#[doc = "No"]
pub mod dac_ipidr;
#[doc = "DAC_SIDR (r) register accessor: an alias for `Reg<DAC_SIDR_SPEC>`"]
