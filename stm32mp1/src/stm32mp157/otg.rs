...
#[doc = "OTG_GOTGCTL (rw) register accessor: an alias for `Reg<OTG_GOTGCTL_SPEC>`"]
...
pub mod otg_gotgctl;
#[doc = "OTG_GOTGINT (rw) register accessor: an alias for `Reg<OTG_GOTGINT_SPEC>`"]
...
pub mod otg_gotgint;
#[doc = "OTG_GAHBCFG (rw) register accessor: an alias for `Reg<OTG_GAHBCFG_SPEC>`"]
...
pub mod otg_gahbcfg;
#[doc = "OTG_GUSBCFG (rw) register accessor: an alias for `Reg<OTG_GUSBCFG_SPEC>`"]
pub type OTG_GUSBCFG = crate::Reg<otg_gusbcfg::OTG_GUSBCFG_SPEC>;
#[doc = "This register can be used to configure the core after power-on or a changing to host mode or device mode. It contains USB and USB-PHY related configuration parameters. The application must program this register before starting any transactions on either the AHB or the USB. Do not make changes to this register after the initial programming."]
pub mod otg_gusbcfg;
#[doc = "OTG_GRSTCTL (rw) register accessor: an alias for `Reg<OTG_GRSTCTL_SPEC>`"]
...
pub mod otg_grstctl;
#[doc = "OTG_GINTSTS (rw) register accessor: an alias for `Reg<OTG_GINTSTS_SPEC>`"]
...
pub mod otg_gintsts;
#[doc = "OTG_GINTMSK (rw) register accessor: an alias for `Reg<OTG_GINTMSK_SPEC>`"]
...
pub mod otg_gintmsk;
#[doc = "OTG_GRXSTSR (r) register accessor: an alias for `Reg<OTG_GRXSTSR_SPEC>`"]
...
pub mod otg_grxstsr;
#[doc = "OTG_GRXSTSP (r) register accessor: an alias for `Reg<OTG_GRXSTSP_SPEC>`"]
...
pub mod otg_grxstsp;
#[doc = "OTG_GRXFSIZ (rw) register accessor: an alias for `Reg<OTG_GRXFSIZ_SPEC>`"]
...
pub mod otg_grxfsiz;
#[doc = "OTG_HNPTXFSIZ (rw) register accessor: an alias for `Reg<OTG_HNPTXFSIZ_SPEC>`"]
pub type OTG_HNPTXFSIZ = crate::Reg<otg_hnptxfsiz::OTG_HNPTXFSIZ_SPEC>;
#[doc = "Host mode"]
pub mod otg_hnptxfsiz;
#[doc = "OTG_HNPTXSTS (r) register accessor: an alias for `Reg<OTG_HNPTXSTS_SPEC>`"]
...
#[doc = "OTG_GCCFG (rw) register accessor: an alias for `Reg<OTG_GCCFG_SPEC>`"]
...
pub mod otg_cid;
#[doc = "OTG_GLPMCFG (rw) register accessor: an alias for `Reg<OTG_GLPMCFG_SPEC>`"]
pub type OTG_GLPMCFG = crate::Reg<otg_glpmcfg::OTG_GLPMCFG_SPEC>;
#[doc = "OTG core LPM configuration register"]
pub mod otg_glpmcfg;
#[doc = "OTG_HPTXFSIZ (rw) register accessor: an alias for `Reg<OTG_HPTXFSIZ_SPEC>`"]
...
#[doc = "OTG_DIEPTXF1 (rw) register accessor: an alias for `Reg<OTG_DIEPTXF1_SPEC>`"]
...
#[doc = "OTG_DIEPTXF2 (rw) register accessor: an alias for `Reg<OTG_DIEPTXF2_SPEC>`"]
...
#[doc = "OTG_DIEPTXF3 (rw) register accessor: an alias for `Reg<OTG_DIEPTXF3_SPEC>`"]
...
#[doc = "OTG_DIEPTXF4 (rw) register accessor: an alias for `Reg<OTG_DIEPTXF4_SPEC>`"]
...
#[doc = "OTG_DIEPTXF5 (rw) register accessor: an alias for `Reg<OTG_DIEPTXF5_SPEC>`"]
...
#[doc = "OTG_DIEPTXF6 (rw) register accessor: an alias for `Reg<OTG_DIEPTXF6_SPEC>`"]
...
#[doc = "OTG_DIEPTXF7 (rw) register accessor: an alias for `Reg<OTG_DIEPTXF7_SPEC>`"]
...
#[doc = "OTG_DIEPTXF8 (rw) register accessor: an alias for `Reg<OTG_DIEPTXF8_SPEC>`"]
...
#[doc = "OTG_HCFG (rw) register accessor: an alias for `Reg<OTG_HCFG_SPEC>`"]
...
pub mod otg_hcfg;
#[doc = "OTG_HFIR (rw) register accessor: an alias for `Reg<OTG_HFIR_SPEC>`"]
...
pub mod otg_hfir;
#[doc = "OTG_HFNUM (r) register accessor: an alias for `Reg<OTG_HFNUM_SPEC>`"]
...
pub mod otg_hfnum;
#[doc = "OTG_HPTXSTS (r) register accessor: an alias for `Reg<OTG_HPTXSTS_SPEC>`"]
...
pub mod otg_hptxsts;
#[doc = "OTG_HAINT (r) register accessor: an alias for `Reg<OTG_HAINT_SPEC>`"]
...
pub mod otg_haint;
#[doc = "OTG_HAINTMSK (rw) register accessor: an alias for `Reg<OTG_HAINTMSK_SPEC>`"]
...
#[doc = "OTG_HFLBADDR (rw) register accessor: an alias for `Reg<OTG_HFLBADDR_SPEC>`"]
...
#[doc = "OTG_HPRT (rw) register accessor: an alias for `Reg<OTG_HPRT_SPEC>`"]
...
pub mod otg_hcint0;
#[doc = "OTG_HCINTMSK0 (rw) register accessor: an alias for `Reg<OTG_HCINTMSK0_SPEC>`"]
...
#[doc = "OTG_HCTSIZ0 (rw) register accessor: an alias for `Reg<OTG_HCTSIZ0_SPEC>`"]
pub type OTG_HCTSIZ0 = crate::Reg<otg_hctsiz0::OTG_HCTSIZ0_SPEC>;
#[doc = "OTG host channel 0 transfer size register"]
pub mod otg_hctsiz0;
#[doc = "OTG_HCDMA0 (rw) register accessor: an alias for `Reg<OTG_HCDMA0_SPEC>`"]
...
pub mod otg_hcdma9;
#[doc = "OTG_HCDMAB9 (r) register accessor: an alias for `Reg<OTG_HCDMAB9_SPEC>`"]
pub type OTG_HCDMAB9 = crate::Reg<otg_hcdmab9::OTG_HCDMAB9_SPEC>;
#[doc = "OTG host channel-n DMA address buffer register"]
pub mod otg_hcdmab9;
#[doc = "OTG_HCCHAR10 (rw) register accessor: an alias for `Reg<OTG_HCCHAR10_SPEC>`"]
...
#[doc = "OTG_HCSPLT10 (rw) register accessor: an alias for `Reg<OTG_HCSPLT10_SPEC>`"]
...
#[doc = "OTG_HCINT10 (rw) register accessor: an alias for `Reg<OTG_HCINT10_SPEC>`"]
pub type OTG_HCINT10 = crate::Reg<otg_hcint10::OTG_HCINT10_SPEC>;
#[doc = "This register indicates the status of a channel with respect to USB- and AHB-related events. It is shown in Figure724. The application must read this register when the host channels interrupt bit in the core interrupt register (HCINT bit in OTG_GINTSTS) is set. Before the application can read this register, it must first read the host all channels interrupt (OTG_HAINT) register to get the exact channel number for the host channel-x interrupt register. The application must clear the appropriate bit in this register to clear the corresponding bits in the OTG_HAINT and OTG_GINTSTS registers."]
pub mod otg_hcint10;
#[doc = "OTG_HCINTMSK10 (rw) register accessor: an alias for `Reg<OTG_HCINTMSK10_SPEC>`"]
pub type OTG_HCINTMSK10 = crate::Reg<otg_hcintmsk10::OTG_HCINTMSK10_SPEC>;
#[doc = "This register reflects the mask for each channel status described in the previous section."]
pub mod otg_hcintmsk10;
#[doc = "OTG_HCTSIZ10 (rw) register accessor: an alias for `Reg<OTG_HCTSIZ10_SPEC>`"]
...
#[doc = "OTG_HCDMA10 (rw) register accessor: an alias for `Reg<OTG_HCDMA10_SPEC>`"]
...
pub mod otg_hcdma10;
#[doc = "OTG_HCDMAB10 (r) register accessor: an alias for `Reg<OTG_HCDMAB10_SPEC>`"]
pub type OTG_HCDMAB10 = crate::Reg<otg_hcdmab10::OTG_HCDMAB10_SPEC>;
#[doc = "OTG host channel-n DMA address buffer register"]
pub mod otg_hcdmab10;
#[doc = "OTG_HCCHAR11 (rw) register accessor: an alias for `Reg<OTG_HCCHAR11_SPEC>`"]
...
#[doc = "OTG_HCSPLT11 (rw) register accessor: an alias for `Reg<OTG_HCSPLT11_SPEC>`"]
...
#[doc = "OTG_HCINT11 (rw) register accessor: an alias for `Reg<OTG_HCINT11_SPEC>`"]
pub type OTG_HCINT11 = crate::Reg<otg_hcint11::OTG_HCINT11_SPEC>;
#[doc = "This register indicates the status of a channel with respect to USB- and AHB-related events. It is shown in Figure724. The application must read this register when the host channels interrupt bit in the core interrupt register (HCINT bit in OTG_GINTSTS) is set. Before the application can read this register, it must first read the host all channels interrupt (OTG_HAINT) register to get the exact channel number for the host channel-x interrupt register. The application must clear the appropriate bit in this register to clear the corresponding bits in the OTG_HAINT and OTG_GINTSTS registers."]
pub mod otg_hcint11;
#[doc = "OTG_HCINTMSK11 (rw) register accessor: an alias for `Reg<OTG_HCINTMSK11_SPEC>`"]
pub type OTG_HCINTMSK11 = crate::Reg<otg_hcintmsk11::OTG_HCINTMSK11_SPEC>;
#[doc = "This register reflects the mask for each channel status described in the previous section."]
pub mod otg_hcintmsk11;
#[doc = "OTG_HCTSIZ11 (rw) register accessor: an alias for `Reg<OTG_HCTSIZ11_SPEC>`"]
...
#[doc = "OTG_HCDMA11 (rw) register accessor: an alias for `Reg<OTG_HCDMA11_SPEC>`"]
...
pub mod otg_hcdma11;
#[doc = "OTG_HCDMAB11 (r) register accessor: an alias for `Reg<OTG_HCDMAB11_SPEC>`"]
pub type OTG_HCDMAB11 = crate::Reg<otg_hcdmab11::OTG_HCDMAB11_SPEC>;
#[doc = "OTG host channel-n DMA address buffer register"]
pub mod otg_hcdmab11;
#[doc = "OTG_HCCHAR12 (rw) register accessor: an alias for `Reg<OTG_HCCHAR12_SPEC>`"]
...
#[doc = "OTG_HCSPLT12 (rw) register accessor: an alias for `Reg<OTG_HCSPLT12_SPEC>`"]
...
#[doc = "OTG_HCINT12 (rw) register accessor: an alias for `Reg<OTG_HCINT12_SPEC>`"]
pub type OTG_HCINT12 = crate::Reg<otg_hcint12::OTG_HCINT12_SPEC>;
#[doc = "This register indicates the status of a channel with respect to USB- and AHB-related events. It is shown in Figure724. The application must read this register when the host channels interrupt bit in the core interrupt register (HCINT bit in OTG_GINTSTS) is set. Before the application can read this register, it must first read the host all channels interrupt (OTG_HAINT) register to get the exact channel number for the host channel-x interrupt register. The application must clear the appropriate bit in this register to clear the corresponding bits in the OTG_HAINT and OTG_GINTSTS registers."]
pub mod otg_hcint12;
#[doc = "OTG_HCINTMSK12 (rw) register accessor: an alias for `Reg<OTG_HCINTMSK12_SPEC>`"]
pub type OTG_HCINTMSK12 = crate::Reg<otg_hcintmsk12::OTG_HCINTMSK12_SPEC>;
#[doc = "This register reflects the mask for each channel status described in the previous section."]
pub mod otg_hcintmsk12;
#[doc = "OTG_HCTSIZ12 (rw) register accessor: an alias for `Reg<OTG_HCTSIZ12_SPEC>`"]
...
#[doc = "OTG_HCDMA12 (rw) register accessor: an alias for `Reg<OTG_HCDMA12_SPEC>`"]
...
pub mod otg_hcdma12;
#[doc = "OTG_HCDMAB12 (r) register accessor: an alias for `Reg<OTG_HCDMAB12_SPEC>`"]
pub type OTG_HCDMAB12 = crate::Reg<otg_hcdmab12::OTG_HCDMAB12_SPEC>;
#[doc = "OTG host channel-n DMA address buffer register"]
pub mod otg_hcdmab12;
#[doc = "OTG_HCCHAR13 (rw) register accessor: an alias for `Reg<OTG_HCCHAR13_SPEC>`"]
...
#[doc = "OTG_HCSPLT13 (rw) register accessor: an alias for `Reg<OTG_HCSPLT13_SPEC>`"]
...
#[doc = "OTG_HCINT13 (rw) register accessor: an alias for `Reg<OTG_HCINT13_SPEC>`"]
pub type OTG_HCINT13 = crate::Reg<otg_hcint13::OTG_HCINT13_SPEC>;
#[doc = "This register indicates the status of a channel with respect to USB- and AHB-related events. It is shown in Figure724. The application must read this register when the host channels interrupt bit in the core interrupt register (HCINT bit in OTG_GINTSTS) is set. Before the application can read this register, it must first read the host all channels interrupt (OTG_HAINT) register to get the exact channel number for the host channel-x interrupt register. The application must clear the appropriate bit in this register to clear the corresponding bits in the OTG_HAINT and OTG_GINTSTS registers."]
pub mod otg_hcint13;
#[doc = "OTG_HCINTMSK13 (rw) register accessor: an alias for `Reg<OTG_HCINTMSK13_SPEC>`"]
pub type OTG_HCINTMSK13 = crate::Reg<otg_hcintmsk13::OTG_HCINTMSK13_SPEC>;
#[doc = "This register reflects the mask for each channel status described in the previous section."]
pub mod otg_hcintmsk13;
#[doc = "OTG_HCTSIZ13 (rw) register accessor: an alias for `Reg<OTG_HCTSIZ13_SPEC>`"]
...
#[doc = "OTG_HCDMA13 (rw) register accessor: an alias for `Reg<OTG_HCDMA13_SPEC>`"]
...
pub mod otg_hcdma13;
#[doc = "OTG_HCDMAB13 (r) register accessor: an alias for `Reg<OTG_HCDMAB13_SPEC>`"]
pub type OTG_HCDMAB13 = crate::Reg<otg_hcdmab13::OTG_HCDMAB13_SPEC>;
#[doc = "OTG host channel-n DMA address buffer register"]
pub mod otg_hcdmab13;
#[doc = "OTG_HCCHAR14 (rw) register accessor: an alias for `Reg<OTG_HCCHAR14_SPEC>`"]
...
#[doc = "OTG_HCSPLT14 (rw) register accessor: an alias for `Reg<OTG_HCSPLT14_SPEC>`"]
...
#[doc = "OTG_HCINT14 (rw) register accessor: an alias for `Reg<OTG_HCINT14_SPEC>`"]
pub type OTG_HCINT14 = crate::Reg<otg_hcint14::OTG_HCINT14_SPEC>;
#[doc = "This register indicates the status of a channel with respect to USB- and AHB-related events. It is shown in Figure724. The application must read this register when the host channels interrupt bit in the core interrupt register (HCINT bit in OTG_GINTSTS) is set. Before the application can read this register, it must first read the host all channels interrupt (OTG_HAINT) register to get the exact channel number for the host channel-x interrupt register. The application must clear the appropriate bit in this register to clear the corresponding bits in the OTG_HAINT and OTG_GINTSTS registers."]
pub mod otg_hcint14;
#[doc = "OTG_HCINTMSK14 (rw) register accessor: an alias for `Reg<OTG_HCINTMSK14_SPEC>`"]
pub type OTG_HCINTMSK14 = crate::Reg<otg_hcintmsk14::OTG_HCINTMSK14_SPEC>;
#[doc = "This register reflects the mask for each channel status described in the previous section."]
pub mod otg_hcintmsk14;
#[doc = "OTG_HCTSIZ14 (rw) register accessor: an alias for `Reg<OTG_HCTSIZ14_SPEC>`"]
...
#[doc = "OTG_HCDMA14 (rw) register accessor: an alias for `Reg<OTG_HCDMA14_SPEC>`"]
...
pub mod otg_hcdma14;
#[doc = "OTG_HCDMAB14 (r) register accessor: an alias for `Reg<OTG_HCDMAB14_SPEC>`"]
pub type OTG_HCDMAB14 = crate::Reg<otg_hcdmab14::OTG_HCDMAB14_SPEC>;
#[doc = "OTG host channel-n DMA address buffer register"]
pub mod otg_hcdmab14;
#[doc = "OTG_HCCHAR15 (rw) register accessor: an alias for `Reg<OTG_HCCHAR15_SPEC>`"]
...
#[doc = "OTG_HCSPLT15 (rw) register accessor: an alias for `Reg<OTG_HCSPLT15_SPEC>`"]
...
#[doc = "OTG_HCINT15 (rw) register accessor: an alias for `Reg<OTG_HCINT15_SPEC>`"]
pub type OTG_HCINT15 = crate::Reg<otg_hcint15::OTG_HCINT15_SPEC>;
#[doc = "This register indicates the status of a channel with respect to USB- and AHB-related events. It is shown in Figure724. The application must read this register when the host channels interrupt bit in the core interrupt register (HCINT bit in OTG_GINTSTS) is set. Before the application can read this register, it must first read the host all channels interrupt (OTG_HAINT) register to get the exact channel number for the host channel-x interrupt register. The application must clear the appropriate bit in this register to clear the corresponding bits in the OTG_HAINT and OTG_GINTSTS registers."]
pub mod otg_hcint15;
#[doc = "OTG_HCINTMSK15 (rw) register accessor: an alias for `Reg<OTG_HCINTMSK15_SPEC>`"]
pub type OTG_HCINTMSK15 = crate::Reg<otg_hcintmsk15::OTG_HCINTMSK15_SPEC>;
#[doc = "This register reflects the mask for each channel status described in the previous section."]
pub mod otg_hcintmsk15;
#[doc = "OTG_HCTSIZ15 (rw) register accessor: an alias for `Reg<OTG_HCTSIZ15_SPEC>`"]
...
#[doc = "OTG_HCDMA15 (rw) register accessor: an alias for `Reg<OTG_HCDMA15_SPEC>`"]
...
pub mod otg_hcdma15;
#[doc = "OTG_HCDMAB15 (r) register accessor: an alias for `Reg<OTG_HCDMAB15_SPEC>`"]
pub type OTG_HCDMAB15 = crate::Reg<otg_hcdmab15::OTG_HCDMAB15_SPEC>;
#[doc = "OTG host channel-n DMA address buffer register"]
pub mod otg_hcdmab15;
#[doc = "OTG_DCFG (rw) register accessor: an alias for `Reg<OTG_DCFG_SPEC>`"]
...
pub mod otg_dcfg;
#[doc = "OTG_DCTL (rw) register accessor: an alias for `Reg<OTG_DCTL_SPEC>`"]
pub type OTG_DCTL = crate::Reg<otg_dctl::OTG_DCTL_SPEC>;
#[doc = "OTG device control register"]
pub mod otg_dctl;
#[doc = "OTG_DSTS (r) register accessor: an alias for `Reg<OTG_DSTS_SPEC>`"]
...
pub mod otg_dsts;
#[doc = "OTG_DIEPMSK (rw) register accessor: an alias for `Reg<OTG_DIEPMSK_SPEC>`"]
...
pub mod otg_diepmsk;
#[doc = "OTG_DOEPMSK (rw) register accessor: an alias for `Reg<OTG_DOEPMSK_SPEC>`"]
pub type OTG_DOEPMSK = crate::Reg<otg_doepmsk::OTG_DOEPMSK_SPEC>;
#[doc = "This register works with each of the OTG_DOEPINTx registers for all endpoints to generate an interrupt per OUT endpoint. The OUT endpoint interrupt for a specific status in the OTG_DOEPINTx register can be masked by writing into the corresponding bit in this register. Status bits are masked by default."]
pub mod otg_doepmsk;
#[doc = "OTG_DAINT (r) register accessor: an alias for `Reg<OTG_DAINT_SPEC>`"]
...
pub mod otg_daint;
#[doc = "OTG_DAINTMSK (rw) register accessor: an alias for `Reg<OTG_DAINTMSK_SPEC>`"]
...
#[doc = "OTG_DVBUSDIS (rw) register accessor: an alias for `Reg<OTG_DVBUSDIS_SPEC>`"]
...
#[doc = "OTG_DVBUSPULSE (rw) register accessor: an alias for `Reg<OTG_DVBUSPULSE_SPEC>`"]
...
#[doc = "OTG_DTHRCTL (rw) register accessor: an alias for `Reg<OTG_DTHRCTL_SPEC>`"]
pub type OTG_DTHRCTL = crate::Reg<otg_dthrctl::OTG_DTHRCTL_SPEC>;
#[doc = "OTG device threshold control register"]
pub mod otg_dthrctl;
#[doc = "OTG_DIEPEMPMSK (rw) register accessor: an alias for `Reg<OTG_DIEPEMPMSK_SPEC>`"]
...
#[doc = "OTG_DEACHINT (r) register accessor: an alias for `Reg<OTG_DEACHINT_SPEC>`"]
...
#[doc = "OTG_DEACHINTMSK (rw) register accessor: an alias for `Reg<OTG_DEACHINTMSK_SPEC>`"]
...
#[doc = "OTG_DIEPCTL0 (rw) register accessor: an alias for `Reg<OTG_DIEPCTL0_SPEC>`"]
...
#[doc = "OTG_DIEPINT0 (rw) register accessor: an alias for `Reg<OTG_DIEPINT0_SPEC>`"]
...
#[doc = "OTG_DIEPTSIZ0 (rw) register accessor: an alias for `Reg<OTG_DIEPTSIZ0_SPEC>`"]
...
#[doc = "OTG_DIEPDMA0 (rw) register accessor: an alias for `Reg<OTG_DIEPDMA0_SPEC>`"]
...
#[doc = "OTG_DTXFSTS0 (r) register accessor: an alias for `Reg<OTG_DTXFSTS0_SPEC>`"]
...
#[doc = "OTG_DIEPCTL1 (rw) register accessor: an alias for `Reg<OTG_DIEPCTL1_SPEC>`"]
pub type OTG_DIEPCTL1 = crate::Reg<otg_diepctl1::OTG_DIEPCTL1_SPEC>;
#[doc = "The application uses this register to control the behavior of each logical endpoint other than endpoint 0."]
pub mod otg_diepctl1;
#[doc = "OTG_DIEPINT1 (rw) register accessor: an alias for `Reg<OTG_DIEPINT1_SPEC>`"]
pub type OTG_DIEPINT1 = crate::Reg<otg_diepint1::OTG_DIEPINT1_SPEC>;
#[doc = "This register indicates the status of an endpoint with respect to USB- and AHB-related events. It is shown in Figure724. The application must read this register when the IN endpoints interrupt bit of the core interrupt register (IEPINT in OTG_GINTSTS) is set. Before the application can read this register, it must first read the device all endpoints interrupt (OTG_DAINT) register to get the exact endpoint number for the device endpoint-x interrupt register. The application must clear the appropriate bit in this register to clear the corresponding bits in the OTG_DAINT and OTG_GINTSTS registers."]
pub mod otg_diepint1;
#[doc = "OTG_DIEPTSIZ1 (rw) register accessor: an alias for `Reg<OTG_DIEPTSIZ1_SPEC>`"]
...
#[doc = "OTG_DIEPDMA1 (rw) register accessor: an alias for `Reg<OTG_DIEPDMA1_SPEC>`"]
...
#[doc = "OTG_DTXFSTS1 (r) register accessor: an alias for `Reg<OTG_DTXFSTS1_SPEC>`"]
pub type OTG_DTXFSTS1 = crate::Reg<otg_dtxfsts1::OTG_DTXFSTS1_SPEC>;
#[doc = "This read-only register contains the free space information for the device IN endpoint Tx FIFO."]
pub mod otg_dtxfsts1;
#[doc = "OTG_DIEPCTL2 (rw) register accessor: an alias for `Reg<OTG_DIEPCTL2_SPEC>`"]
pub type OTG_DIEPCTL2 = crate::Reg<otg_diepctl2::OTG_DIEPCTL2_SPEC>;
#[doc = "The application uses this register to control the behavior of each logical endpoint other than endpoint 0."]
pub mod otg_diepctl2;
#[doc = "OTG_DIEPINT2 (rw) register accessor: an alias for `Reg<OTG_DIEPINT2_SPEC>`"]
pub type OTG_DIEPINT2 = crate::Reg<otg_diepint2::OTG_DIEPINT2_SPEC>;
#[doc = "This register indicates the status of an endpoint with respect to USB- and AHB-related events. It is shown in Figure724. The application must read this register when the IN endpoints interrupt bit of the core interrupt register (IEPINT in OTG_GINTSTS) is set. Before the application can read this register, it must first read the device all endpoints interrupt (OTG_DAINT) register to get the exact endpoint number for the device endpoint-x interrupt register. The application must clear the appropriate bit in this register to clear the corresponding bits in the OTG_DAINT and OTG_GINTSTS registers."]
pub mod otg_diepint2;
#[doc = "OTG_DIEPTSIZ2 (rw) register accessor: an alias for `Reg<OTG_DIEPTSIZ2_SPEC>`"]
pub type OTG_DIEPTSIZ2 = crate::Reg<otg_dieptsiz2::OTG_DIEPTSIZ2_SPEC>;
#[doc = "The application must modify this register before enabling the endpoint. Once the endpoint is enabled using the endpoint enable bit in the OTG_DIEPCTLx registers (EPENA bit in OTG_DIEPCTLx), the core modifies this register. The application can only read this register once the core has cleared the endpoint enable bit."]
pub mod otg_dieptsiz2;
#[doc = "OTG_DIEPDMA2 (rw) register accessor: an alias for `Reg<OTG_DIEPDMA2_SPEC>`"]
...
#[doc = "OTG_DTXFSTS2 (r) register accessor: an alias for `Reg<OTG_DTXFSTS2_SPEC>`"]
pub type OTG_DTXFSTS2 = crate::Reg<otg_dtxfsts2::OTG_DTXFSTS2_SPEC>;
#[doc = "This read-only register contains the free space information for the device IN endpoint Tx FIFO."]
pub mod otg_dtxfsts2;
#[doc = "OTG_DIEPCTL3 (rw) register accessor: an alias for `Reg<OTG_DIEPCTL3_SPEC>`"]
pub type OTG_DIEPCTL3 = crate::Reg<otg_diepctl3::OTG_DIEPCTL3_SPEC>;
#[doc = "The application uses this register to control the behavior of each logical endpoint other than endpoint 0."]
pub mod otg_diepctl3;
#[doc = "OTG_DIEPINT3 (rw) register accessor: an alias for `Reg<OTG_DIEPINT3_SPEC>`"]
pub type OTG_DIEPINT3 = crate::Reg<otg_diepint3::OTG_DIEPINT3_SPEC>;
#[doc = "This register indicates the status of an endpoint with respect to USB- and AHB-related events. It is shown in Figure724. The application must read this register when the IN endpoints interrupt bit of the core interrupt register (IEPINT in OTG_GINTSTS) is set. Before the application can read this register, it must first read the device all endpoints interrupt (OTG_DAINT) register to get the exact endpoint number for the device endpoint-x interrupt register. The application must clear the appropriate bit in this register to clear the corresponding bits in the OTG_DAINT and OTG_GINTSTS registers."]
pub mod otg_diepint3;
#[doc = "OTG_DIEPTSIZ3 (rw) register accessor: an alias for `Reg<OTG_DIEPTSIZ3_SPEC>`"]
pub type OTG_DIEPTSIZ3 = crate::Reg<otg_dieptsiz3::OTG_DIEPTSIZ3_SPEC>;
#[doc = "The application must modify this register before enabling the endpoint. Once the endpoint is enabled using the endpoint enable bit in the OTG_DIEPCTLx registers (EPENA bit in OTG_DIEPCTLx), the core modifies this register. The application can only read this register once the core has cleared the endpoint enable bit."]
pub mod otg_dieptsiz3;
#[doc = "OTG_DIEPDMA3 (rw) register accessor: an alias for `Reg<OTG_DIEPDMA3_SPEC>`"]
...
#[doc = "OTG_DTXFSTS3 (r) register accessor: an alias for `Reg<OTG_DTXFSTS3_SPEC>`"]
pub type OTG_DTXFSTS3 = crate::Reg<otg_dtxfsts3::OTG_DTXFSTS3_SPEC>;
#[doc = "This read-only register contains the free space information for the device IN endpoint Tx FIFO."]
pub mod otg_dtxfsts3;
#[doc = "OTG_DIEPCTL4 (rw) register accessor: an alias for `Reg<OTG_DIEPCTL4_SPEC>`"]
pub type OTG_DIEPCTL4 = crate::Reg<otg_diepctl4::OTG_DIEPCTL4_SPEC>;
#[doc = "The application uses this register to control the behavior of each logical endpoint other than endpoint 0."]
pub mod otg_diepctl4;
#[doc = "OTG_DIEPINT4 (rw) register accessor: an alias for `Reg<OTG_DIEPINT4_SPEC>`"]
pub type OTG_DIEPINT4 = crate::Reg<otg_diepint4::OTG_DIEPINT4_SPEC>;
#[doc = "This register indicates the status of an endpoint with respect to USB- and AHB-related events. It is shown in Figure724. The application must read this register when the IN endpoints interrupt bit of the core interrupt register (IEPINT in OTG_GINTSTS) is set. Before the application can read this register, it must first read the device all endpoints interrupt (OTG_DAINT) register to get the exact endpoint number for the device endpoint-x interrupt register. The application must clear the appropriate bit in this register to clear the corresponding bits in the OTG_DAINT and OTG_GINTSTS registers."]
pub mod otg_diepint4;
#[doc = "OTG_DIEPTSIZ4 (rw) register accessor: an alias for `Reg<OTG_DIEPTSIZ4_SPEC>`"]
pub type OTG_DIEPTSIZ4 = crate::Reg<otg_dieptsiz4::OTG_DIEPTSIZ4_SPEC>;
#[doc = "The application must modify this register before enabling the endpoint. Once the endpoint is enabled using the endpoint enable bit in the OTG_DIEPCTLx registers (EPENA bit in OTG_DIEPCTLx), the core modifies this register. The application can only read this register once the core has cleared the endpoint enable bit."]
pub mod otg_dieptsiz4;
#[doc = "OTG_DIEPDMA4 (rw) register accessor: an alias for `Reg<OTG_DIEPDMA4_SPEC>`"]
...
#[doc = "OTG_DTXFSTS4 (r) register accessor: an alias for `Reg<OTG_DTXFSTS4_SPEC>`"]
pub type OTG_DTXFSTS4 = crate::Reg<otg_dtxfsts4::OTG_DTXFSTS4_SPEC>;
#[doc = "This read-only register contains the free space information for the device IN endpoint Tx FIFO."]
pub mod otg_dtxfsts4;
#[doc = "OTG_DIEPCTL5 (rw) register accessor: an alias for `Reg<OTG_DIEPCTL5_SPEC>`"]
pub type OTG_DIEPCTL5 = crate::Reg<otg_diepctl5::OTG_DIEPCTL5_SPEC>;
#[doc = "The application uses this register to control the behavior of each logical endpoint other than endpoint 0."]
pub mod otg_diepctl5;
#[doc = "OTG_DIEPINT5 (rw) register accessor: an alias for `Reg<OTG_DIEPINT5_SPEC>`"]
pub type OTG_DIEPINT5 = crate::Reg<otg_diepint5::OTG_DIEPINT5_SPEC>;
#[doc = "This register indicates the status of an endpoint with respect to USB- and AHB-related events. It is shown in Figure724. The application must read this register when the IN endpoints interrupt bit of the core interrupt register (IEPINT in OTG_GINTSTS) is set. Before the application can read this register, it must first read the device all endpoints interrupt (OTG_DAINT) register to get the exact endpoint number for the device endpoint-x interrupt register. The application must clear the appropriate bit in this register to clear the corresponding bits in the OTG_DAINT and OTG_GINTSTS registers."]
pub mod otg_diepint5;
#[doc = "OTG_DIEPTSIZ5 (rw) register accessor: an alias for `Reg<OTG_DIEPTSIZ5_SPEC>`"]
pub type OTG_DIEPTSIZ5 = crate::Reg<otg_dieptsiz5::OTG_DIEPTSIZ5_SPEC>;
#[doc = "The application must modify this register before enabling the endpoint. Once the endpoint is enabled using the endpoint enable bit in the OTG_DIEPCTLx registers (EPENA bit in OTG_DIEPCTLx), the core modifies this register. The application can only read this register once the core has cleared the endpoint enable bit."]
pub mod otg_dieptsiz5;
#[doc = "OTG_DIEPDMA5 (rw) register accessor: an alias for `Reg<OTG_DIEPDMA5_SPEC>`"]
...
#[doc = "OTG_DTXFSTS5 (r) register accessor: an alias for `Reg<OTG_DTXFSTS5_SPEC>`"]
pub type OTG_DTXFSTS5 = crate::Reg<otg_dtxfsts5::OTG_DTXFSTS5_SPEC>;
#[doc = "This read-only register contains the free space information for the device IN endpoint Tx FIFO."]
pub mod otg_dtxfsts5;
#[doc = "OTG_DIEPCTL6 (rw) register accessor: an alias for `Reg<OTG_DIEPCTL6_SPEC>`"]
pub type OTG_DIEPCTL6 = crate::Reg<otg_diepctl6::OTG_DIEPCTL6_SPEC>;
#[doc = "The application uses this register to control the behavior of each logical endpoint other than endpoint 0."]
pub mod otg_diepctl6;
#[doc = "OTG_DIEPINT6 (rw) register accessor: an alias for `Reg<OTG_DIEPINT6_SPEC>`"]
pub type OTG_DIEPINT6 = crate::Reg<otg_diepint6::OTG_DIEPINT6_SPEC>;
#[doc = "This register indicates the status of an endpoint with respect to USB- and AHB-related events. It is shown in Figure724. The application must read this register when the IN endpoints interrupt bit of the core interrupt register (IEPINT in OTG_GINTSTS) is set. Before the application can read this register, it must first read the device all endpoints interrupt (OTG_DAINT) register to get the exact endpoint number for the device endpoint-x interrupt register. The application must clear the appropriate bit in this register to clear the corresponding bits in the OTG_DAINT and OTG_GINTSTS registers."]
pub mod otg_diepint6;
#[doc = "OTG_DIEPTSIZ6 (rw) register accessor: an alias for `Reg<OTG_DIEPTSIZ6_SPEC>`"]
pub type OTG_DIEPTSIZ6 = crate::Reg<otg_dieptsiz6::OTG_DIEPTSIZ6_SPEC>;
#[doc = "The application must modify this register before enabling the endpoint. Once the endpoint is enabled using the endpoint enable bit in the OTG_DIEPCTLx registers (EPENA bit in OTG_DIEPCTLx), the core modifies this register. The application can only read this register once the core has cleared the endpoint enable bit."]
pub mod otg_dieptsiz6;
#[doc = "OTG_DIEPDMA6 (rw) register accessor: an alias for `Reg<OTG_DIEPDMA6_SPEC>`"]
...
#[doc = "OTG_DTXFSTS6 (r) register accessor: an alias for `Reg<OTG_DTXFSTS6_SPEC>`"]
pub type OTG_DTXFSTS6 = crate::Reg<otg_dtxfsts6::OTG_DTXFSTS6_SPEC>;
#[doc = "This read-only register contains the free space information for the device IN endpoint Tx FIFO."]
pub mod otg_dtxfsts6;
#[doc = "OTG_DIEPCTL7 (rw) register accessor: an alias for `Reg<OTG_DIEPCTL7_SPEC>`"]
pub type OTG_DIEPCTL7 = crate::Reg<otg_diepctl7::OTG_DIEPCTL7_SPEC>;
#[doc = "The application uses this register to control the behavior of each logical endpoint other than endpoint 0."]
pub mod otg_diepctl7;
#[doc = "OTG_DIEPINT7 (rw) register accessor: an alias for `Reg<OTG_DIEPINT7_SPEC>`"]
pub type OTG_DIEPINT7 = crate::Reg<otg_diepint7::OTG_DIEPINT7_SPEC>;
#[doc = "This register indicates the status of an endpoint with respect to USB- and AHB-related events. It is shown in Figure724. The application must read this register when the IN endpoints interrupt bit of the core interrupt register (IEPINT in OTG_GINTSTS) is set. Before the application can read this register, it must first read the device all endpoints interrupt (OTG_DAINT) register to get the exact endpoint number for the device endpoint-x interrupt register. The application must clear the appropriate bit in this register to clear the corresponding bits in the OTG_DAINT and OTG_GINTSTS registers."]
pub mod otg_diepint7;
#[doc = "OTG_DIEPTSIZ7 (rw) register accessor: an alias for `Reg<OTG_DIEPTSIZ7_SPEC>`"]
pub type OTG_DIEPTSIZ7 = crate::Reg<otg_dieptsiz7::OTG_DIEPTSIZ7_SPEC>;
#[doc = "The application must modify this register before enabling the endpoint. Once the endpoint is enabled using the endpoint enable bit in the OTG_DIEPCTLx registers (EPENA bit in OTG_DIEPCTLx), the core modifies this register. The application can only read this register once the core has cleared the endpoint enable bit."]
pub mod otg_dieptsiz7;
#[doc = "OTG_DIEPDMA7 (rw) register accessor: an alias for `Reg<OTG_DIEPDMA7_SPEC>`"]
...
#[doc = "OTG_DTXFSTS7 (r) register accessor: an alias for `Reg<OTG_DTXFSTS7_SPEC>`"]
pub type OTG_DTXFSTS7 = crate::Reg<otg_dtxfsts7::OTG_DTXFSTS7_SPEC>;
#[doc = "This read-only register contains the free space information for the device IN endpoint Tx FIFO."]
pub mod otg_dtxfsts7;
#[doc = "OTG_DIEPCTL8 (rw) register accessor: an alias for `Reg<OTG_DIEPCTL8_SPEC>`"]
pub type OTG_DIEPCTL8 = crate::Reg<otg_diepctl8::OTG_DIEPCTL8_SPEC>;
#[doc = "The application uses this register to control the behavior of each logical endpoint other than endpoint 0."]
pub mod otg_diepctl8;
#[doc = "OTG_DIEPINT8 (rw) register accessor: an alias for `Reg<OTG_DIEPINT8_SPEC>`"]
pub type OTG_DIEPINT8 = crate::Reg<otg_diepint8::OTG_DIEPINT8_SPEC>;
#[doc = "This register indicates the status of an endpoint with respect to USB- and AHB-related events. It is shown in Figure724. The application must read this register when the IN endpoints interrupt bit of the core interrupt register (IEPINT in OTG_GINTSTS) is set. Before the application can read this register, it must first read the device all endpoints interrupt (OTG_DAINT) register to get the exact endpoint number for the device endpoint-x interrupt register. The application must clear the appropriate bit in this register to clear the corresponding bits in the OTG_DAINT and OTG_GINTSTS registers."]
pub mod otg_diepint8;
#[doc = "OTG_DIEPTSIZ8 (rw) register accessor: an alias for `Reg<OTG_DIEPTSIZ8_SPEC>`"]
pub type OTG_DIEPTSIZ8 = crate::Reg<otg_dieptsiz8::OTG_DIEPTSIZ8_SPEC>;
#[doc = "The application must modify this register before enabling the endpoint. Once the endpoint is enabled using the endpoint enable bit in the OTG_DIEPCTLx registers (EPENA bit in OTG_DIEPCTLx), the core modifies this register. The application can only read this register once the core has cleared the endpoint enable bit."]
pub mod otg_dieptsiz8;
#[doc = "OTG_DIEPDMA8 (rw) register accessor: an alias for `Reg<OTG_DIEPDMA8_SPEC>`"]
...
#[doc = "OTG_DTXFSTS8 (r) register accessor: an alias for `Reg<OTG_DTXFSTS8_SPEC>`"]
pub type OTG_DTXFSTS8 = crate::Reg<otg_dtxfsts8::OTG_DTXFSTS8_SPEC>;
#[doc = "This read-only register contains the free space information for the device IN endpoint Tx FIFO."]
pub mod otg_dtxfsts8;
#[doc = "OTG_DOEPCTL0 (rw) register accessor: an alias for `Reg<OTG_DOEPCTL0_SPEC>`"]
...
#[doc = "OTG_DOEPINT0 (rw) register accessor: an alias for `Reg<OTG_DOEPINT0_SPEC>`"]
...
#[doc = "OTG_DOEPTSIZ0 (rw) register accessor: an alias for `Reg<OTG_DOEPTSIZ0_SPEC>`"]
pub type OTG_DOEPTSIZ0 = crate::Reg<otg_doeptsiz0::OTG_DOEPTSIZ0_SPEC>;
#[doc = "The application must modify this register before enabling endpoint 0."]
pub mod otg_doeptsiz0;
#[doc = "OTG_DOEPDMA0 (rw) register accessor: an alias for `Reg<OTG_DOEPDMA0_SPEC>`"]
...
#[doc = "OTG_DOEPCTL1 (rw) register accessor: an alias for `Reg<OTG_DOEPCTL1_SPEC>`"]
pub type OTG_DOEPCTL1 = crate::Reg<otg_doepctl1::OTG_DOEPCTL1_SPEC>;
#[doc = "The application uses this register to control the behavior of each logical endpoint other than endpoint 0."]
pub mod otg_doepctl1;
#[doc = "OTG_DOEPINT1 (rw) register accessor: an alias for `Reg<OTG_DOEPINT1_SPEC>`"]
pub type OTG_DOEPINT1 = crate::Reg<otg_doepint1::OTG_DOEPINT1_SPEC>;
#[doc = "This register indicates the status of an endpoint with respect to USB- and AHB-related events. It is shown in Figure724. The application must read this register when the OUT endpoints interrupt bit of the OTG_GINTSTS register (OEPINT bit in OTG_GINTSTS) is set. Before the application can read this register, it must first read the OTG_DAINT register to get the exact endpoint number for the OTG_DOEPINTx register. The application must clear the appropriate bit in this register to clear the corresponding bits in the OTG_DAINT and OTG_GINTSTS registers."]
pub mod otg_doepint1;
#[doc = "OTG_DOEPTSIZ1 (rw) register accessor: an alias for `Reg<OTG_DOEPTSIZ1_SPEC>`"]
...
#[doc = "OTG_DOEPDMA1 (rw) register accessor: an alias for `Reg<OTG_DOEPDMA1_SPEC>`"]
...
#[doc = "OTG_DOEPCTL2 (rw) register accessor: an alias for `Reg<OTG_DOEPCTL2_SPEC>`"]
pub type OTG_DOEPCTL2 = crate::Reg<otg_doepctl2::OTG_DOEPCTL2_SPEC>;
#[doc = "The application uses this register to control the behavior of each logical endpoint other than endpoint 0."]
pub mod otg_doepctl2;
#[doc = "OTG_DOEPINT2 (rw) register accessor: an alias for `Reg<OTG_DOEPINT2_SPEC>`"]
pub type OTG_DOEPINT2 = crate::Reg<otg_doepint2::OTG_DOEPINT2_SPEC>;
#[doc = "This register indicates the status of an endpoint with respect to USB- and AHB-related events. It is shown in Figure724. The application must read this register when the OUT endpoints interrupt bit of the OTG_GINTSTS register (OEPINT bit in OTG_GINTSTS) is set. Before the application can read this register, it must first read the OTG_DAINT register to get the exact endpoint number for the OTG_DOEPINTx register. The application must clear the appropriate bit in this register to clear the corresponding bits in the OTG_DAINT and OTG_GINTSTS registers."]
pub mod otg_doepint2;
#[doc = "OTG_DOEPTSIZ2 (rw) register accessor: an alias for `Reg<OTG_DOEPTSIZ2_SPEC>`"]
pub type OTG_DOEPTSIZ2 = crate::Reg<otg_doeptsiz2::OTG_DOEPTSIZ2_SPEC>;
#[doc = "The application must modify this register before enabling the endpoint. Once the endpoint is enabled using endpoint enable bit of the OTG_DOEPCTLx registers (EPENA bit in OTG_DOEPCTLx), the core modifies this register. The application can only read this register once the core has cleared the endpoint enable bit."]
pub mod otg_doeptsiz2;
#[doc = "OTG_DOEPDMA2 (rw) register accessor: an alias for `Reg<OTG_DOEPDMA2_SPEC>`"]
...
#[doc = "OTG_DOEPCTL3 (rw) register accessor: an alias for `Reg<OTG_DOEPCTL3_SPEC>`"]
pub type OTG_DOEPCTL3 = crate::Reg<otg_doepctl3::OTG_DOEPCTL3_SPEC>;
#[doc = "The application uses this register to control the behavior of each logical endpoint other than endpoint 0."]
pub mod otg_doepctl3;
#[doc = "OTG_DOEPINT3 (rw) register accessor: an alias for `Reg<OTG_DOEPINT3_SPEC>`"]
pub type OTG_DOEPINT3 = crate::Reg<otg_doepint3::OTG_DOEPINT3_SPEC>;
#[doc = "This register indicates the status of an endpoint with respect to USB- and AHB-related events. It is shown in Figure724. The application must read this register when the OUT endpoints interrupt bit of the OTG_GINTSTS register (OEPINT bit in OTG_GINTSTS) is set. Before the application can read this register, it must first read the OTG_DAINT register to get the exact endpoint number for the OTG_DOEPINTx register. The application must clear the appropriate bit in this register to clear the corresponding bits in the OTG_DAINT and OTG_GINTSTS registers."]
pub mod otg_doepint3;
#[doc = "OTG_DOEPTSIZ3 (rw) register accessor: an alias for `Reg<OTG_DOEPTSIZ3_SPEC>`"]
pub type OTG_DOEPTSIZ3 = crate::Reg<otg_doeptsiz3::OTG_DOEPTSIZ3_SPEC>;
#[doc = "The application must modify this register before enabling the endpoint. Once the endpoint is enabled using endpoint enable bit of the OTG_DOEPCTLx registers (EPENA bit in OTG_DOEPCTLx), the core modifies this register. The application can only read this register once the core has cleared the endpoint enable bit."]
pub mod otg_doeptsiz3;
#[doc = "OTG_DOEPDMA3 (rw) register accessor: an alias for `Reg<OTG_DOEPDMA3_SPEC>`"]
...
#[doc = "OTG_DOEPCTL4 (rw) register accessor: an alias for `Reg<OTG_DOEPCTL4_SPEC>`"]
pub type OTG_DOEPCTL4 = crate::Reg<otg_doepctl4::OTG_DOEPCTL4_SPEC>;
#[doc = "The application uses this register to control the behavior of each logical endpoint other than endpoint 0."]
pub mod otg_doepctl4;
#[doc = "OTG_DOEPINT4 (rw) register accessor: an alias for `Reg<OTG_DOEPINT4_SPEC>`"]
pub type OTG_DOEPINT4 = crate::Reg<otg_doepint4::OTG_DOEPINT4_SPEC>;
#[doc = "This register indicates the status of an endpoint with respect to USB- and AHB-related events. It is shown in Figure724. The application must read this register when the OUT endpoints interrupt bit of the OTG_GINTSTS register (OEPINT bit in OTG_GINTSTS) is set. Before the application can read this register, it must first read the OTG_DAINT register to get the exact endpoint number for the OTG_DOEPINTx register. The application must clear the appropriate bit in this register to clear the corresponding bits in the OTG_DAINT and OTG_GINTSTS registers."]
pub mod otg_doepint4;
#[doc = "OTG_DOEPTSIZ4 (rw) register accessor: an alias for `Reg<OTG_DOEPTSIZ4_SPEC>`"]
pub type OTG_DOEPTSIZ4 = crate::Reg<otg_doeptsiz4::OTG_DOEPTSIZ4_SPEC>;
#[doc = "The application must modify this register before enabling the endpoint. Once the endpoint is enabled using endpoint enable bit of the OTG_DOEPCTLx registers (EPENA bit in OTG_DOEPCTLx), the core modifies this register. The application can only read this register once the core has cleared the endpoint enable bit."]
pub mod otg_doeptsiz4;
#[doc = "OTG_DOEPDMA4 (rw) register accessor: an alias for `Reg<OTG_DOEPDMA4_SPEC>`"]
...
#[doc = "OTG_DOEPCTL5 (rw) register accessor: an alias for `Reg<OTG_DOEPCTL5_SPEC>`"]
pub type OTG_DOEPCTL5 = crate::Reg<otg_doepctl5::OTG_DOEPCTL5_SPEC>;
#[doc = "The application uses this register to control the behavior of each logical endpoint other than endpoint 0."]
pub mod otg_doepctl5;
#[doc = "OTG_DOEPINT5 (rw) register accessor: an alias for `Reg<OTG_DOEPINT5_SPEC>`"]
pub type OTG_DOEPINT5 = crate::Reg<otg_doepint5::OTG_DOEPINT5_SPEC>;
#[doc = "This register indicates the status of an endpoint with respect to USB- and AHB-related events. It is shown in Figure724. The application must read this register when the OUT endpoints interrupt bit of the OTG_GINTSTS register (OEPINT bit in OTG_GINTSTS) is set. Before the application can read this register, it must first read the OTG_DAINT register to get the exact endpoint number for the OTG_DOEPINTx register. The application must clear the appropriate bit in this register to clear the corresponding bits in the OTG_DAINT and OTG_GINTSTS registers."]
pub mod otg_doepint5;
#[doc = "OTG_DOEPTSIZ5 (rw) register accessor: an alias for `Reg<OTG_DOEPTSIZ5_SPEC>`"]
pub type OTG_DOEPTSIZ5 = crate::Reg<otg_doeptsiz5::OTG_DOEPTSIZ5_SPEC>;
#[doc = "The application must modify this register before enabling the endpoint. Once the endpoint is enabled using endpoint enable bit of the OTG_DOEPCTLx registers (EPENA bit in OTG_DOEPCTLx), the core modifies this register. The application can only read this register once the core has cleared the endpoint enable bit."]
pub mod otg_doeptsiz5;
#[doc = "OTG_DOEPDMA5 (rw) register accessor: an alias for `Reg<OTG_DOEPDMA5_SPEC>`"]
...
#[doc = "OTG_DOEPCTL6 (rw) register accessor: an alias for `Reg<OTG_DOEPCTL6_SPEC>`"]
pub type OTG_DOEPCTL6 = crate::Reg<otg_doepctl6::OTG_DOEPCTL6_SPEC>;
#[doc = "The application uses this register to control the behavior of each logical endpoint other than endpoint 0."]
pub mod otg_doepctl6;
#[doc = "OTG_DOEPINT6 (rw) register accessor: an alias for `Reg<OTG_DOEPINT6_SPEC>`"]
pub type OTG_DOEPINT6 = crate::Reg<otg_doepint6::OTG_DOEPINT6_SPEC>;
#[doc = "This register indicates the status of an endpoint with respect to USB- and AHB-related events. It is shown in Figure724. The application must read this register when the OUT endpoints interrupt bit of the OTG_GINTSTS register (OEPINT bit in OTG_GINTSTS) is set. Before the application can read this register, it must first read the OTG_DAINT register to get the exact endpoint number for the OTG_DOEPINTx register. The application must clear the appropriate bit in this register to clear the corresponding bits in the OTG_DAINT and OTG_GINTSTS registers."]
pub mod otg_doepint6;
#[doc = "OTG_DOEPTSIZ6 (rw) register accessor: an alias for `Reg<OTG_DOEPTSIZ6_SPEC>`"]
pub type OTG_DOEPTSIZ6 = crate::Reg<otg_doeptsiz6::OTG_DOEPTSIZ6_SPEC>;
#[doc = "The application must modify this register before enabling the endpoint. Once the endpoint is enabled using endpoint enable bit of the OTG_DOEPCTLx registers (EPENA bit in OTG_DOEPCTLx), the core modifies this register. The application can only read this register once the core has cleared the endpoint enable bit."]
pub mod otg_doeptsiz6;
#[doc = "OTG_DOEPDMA6 (rw) register accessor: an alias for `Reg<OTG_DOEPDMA6_SPEC>`"]
...
#[doc = "OTG_DOEPCTL7 (rw) register accessor: an alias for `Reg<OTG_DOEPCTL7_SPEC>`"]
pub type OTG_DOEPCTL7 = crate::Reg<otg_doepctl7::OTG_DOEPCTL7_SPEC>;
#[doc = "The application uses this register to control the behavior of each logical endpoint other than endpoint 0."]
pub mod otg_doepctl7;
#[doc = "OTG_DOEPINT7 (rw) register accessor: an alias for `Reg<OTG_DOEPINT7_SPEC>`"]
pub type OTG_DOEPINT7 = crate::Reg<otg_doepint7::OTG_DOEPINT7_SPEC>;
#[doc = "This register indicates the status of an endpoint with respect to USB- and AHB-related events. It is shown in Figure724. The application must read this register when the OUT endpoints interrupt bit of the OTG_GINTSTS register (OEPINT bit in OTG_GINTSTS) is set. Before the application can read this register, it must first read the OTG_DAINT register to get the exact endpoint number for the OTG_DOEPINTx register. The application must clear the appropriate bit in this register to clear the corresponding bits in the OTG_DAINT and OTG_GINTSTS registers."]
pub mod otg_doepint7;
#[doc = "OTG_DOEPTSIZ7 (rw) register accessor: an alias for `Reg<OTG_DOEPTSIZ7_SPEC>`"]
pub type OTG_DOEPTSIZ7 = crate::Reg<otg_doeptsiz7::OTG_DOEPTSIZ7_SPEC>;
#[doc = "The application must modify this register before enabling the endpoint. Once the endpoint is enabled using endpoint enable bit of the OTG_DOEPCTLx registers (EPENA bit in OTG_DOEPCTLx), the core modifies this register. The application can only read this register once the core has cleared the endpoint enable bit."]
pub mod otg_doeptsiz7;
#[doc = "OTG_DOEPDMA7 (rw) register accessor: an alias for `Reg<OTG_DOEPDMA7_SPEC>`"]
...
#[doc = "OTG_DOEPCTL8 (rw) register accessor: an alias for `Reg<OTG_DOEPCTL8_SPEC>`"]
pub type OTG_DOEPCTL8 = crate::Reg<otg_doepctl8::OTG_DOEPCTL8_SPEC>;
#[doc = "The application uses this register to control the behavior of each logical endpoint other than endpoint 0."]
pub mod otg_doepctl8;
#[doc = "OTG_DOEPINT8 (rw) register accessor: an alias for `Reg<OTG_DOEPINT8_SPEC>`"]
pub type OTG_DOEPINT8 = crate::Reg<otg_doepint8::OTG_DOEPINT8_SPEC>;
#[doc = "This register indicates the status of an endpoint with respect to USB- and AHB-related events. It is shown in Figure724. The application must read this register when the OUT endpoints interrupt bit of the OTG_GINTSTS register (OEPINT bit in OTG_GINTSTS) is set. Before the application can read this register, it must first read the OTG_DAINT register to get the exact endpoint number for the OTG_DOEPINTx register. The application must clear the appropriate bit in this register to clear the corresponding bits in the OTG_DAINT and OTG_GINTSTS registers."]
pub mod otg_doepint8;
#[doc = "OTG_DOEPTSIZ8 (rw) register accessor: an alias for `Reg<OTG_DOEPTSIZ8_SPEC>`"]
pub type OTG_DOEPTSIZ8 = crate::Reg<otg_doeptsiz8::OTG_DOEPTSIZ8_SPEC>;
#[doc = "The application must modify this register before enabling the endpoint. Once the endpoint is enabled using endpoint enable bit of the OTG_DOEPCTLx registers (EPENA bit in OTG_DOEPCTLx), the core modifies this register. The application can only read this register once the core has cleared the endpoint enable bit."]
pub mod otg_doeptsiz8;
#[doc = "OTG_DOEPDMA8 (rw) register accessor: an alias for `Reg<OTG_DOEPDMA8_SPEC>`"]
...
#[doc = "OTG_PCGCCTL (rw) register accessor: an alias for `Reg<OTG_PCGCCTL_SPEC>`"]
