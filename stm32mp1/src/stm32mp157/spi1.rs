...
pub mod spi_cfg2;
#[doc = "SPI_CRCPOLY (rw) register accessor: an alias for `Reg<SPI_CRCPOLY_SPEC>`"]
pub type SPI_CRCPOLY = crate::Reg<spi_crcpoly::SPI_CRCPOLY_SPEC>;
#[doc = "SPI polynomial register"]
pub mod spi_crcpoly;
#[doc = "SPI_TXCRC (r) register accessor: an alias for `Reg<SPI_TXCRC_SPEC>`"]
pub type SPI_TXCRC = crate::Reg<spi_txcrc::SPI_TXCRC_SPEC>;
#[doc = "SPI transmitter CRC register"]
pub mod spi_txcrc;
#[doc = "SPI_RXCRC (r) register accessor: an alias for `Reg<SPI_RXCRC_SPEC>`"]
pub type SPI_RXCRC = crate::Reg<spi_rxcrc::SPI_RXCRC_SPEC>;
#[doc = "SPI receiver CRC register"]
pub mod spi_rxcrc;
#[doc = "SPI_UDRDR (rw) register accessor: an alias for `Reg<SPI_UDRDR_SPEC>`"]
pub type SPI_UDRDR = crate::Reg<spi_udrdr::SPI_UDRDR_SPEC>;
#[doc = "SPI underrun data register"]
pub mod spi_udrdr;
#[doc = "SPI_I2SCFGR (rw) register accessor: an alias for `Reg<SPI_I2SCFGR_SPEC>`"]
...
pub mod spi_i2scfgr;
#[doc = "SPI_I2S_HWCFGR (r) register accessor: an alias for `Reg<SPI_I2S_HWCFGR_SPEC>`"]
...
#[doc = "SPI_VERR (r) register accessor: an alias for `Reg<SPI_VERR_SPEC>`"]
pub type SPI_VERR = crate::Reg<spi_verr::SPI_VERR_SPEC>;
#[doc = "SPI/I2S version register"]
pub mod spi_verr;
#[doc = "SPI_IPIDR (r) register accessor: an alias for `Reg<SPI_IPIDR_SPEC>`"]
pub type SPI_IPIDR = crate::Reg<spi_ipidr::SPI_IPIDR_SPEC>;
#[doc = "SPI/I2S identification register"]
pub mod spi_ipidr;
#[doc = "SPI_SIDR (r) register accessor: an alias for `Reg<SPI_SIDR_SPEC>`"]
