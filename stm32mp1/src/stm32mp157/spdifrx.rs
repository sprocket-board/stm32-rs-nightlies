...
#[doc = "SPDIFRX_CR (rw) register accessor: an alias for `Reg<SPDIFRX_CR_SPEC>`"]
pub type SPDIFRX_CR = crate::Reg<spdifrx_cr::SPDIFRX_CR_SPEC>;
#[doc = "Control register"]
pub mod spdifrx_cr;
#[doc = "SPDIFRX_IMR (rw) register accessor: an alias for `Reg<SPDIFRX_IMR_SPEC>`"]
pub type SPDIFRX_IMR = crate::Reg<spdifrx_imr::SPDIFRX_IMR_SPEC>;
#[doc = "Interrupt mask register"]
pub mod spdifrx_imr;
#[doc = "SPDIFRX_SR (r) register accessor: an alias for `Reg<SPDIFRX_SR_SPEC>`"]
pub type SPDIFRX_SR = crate::Reg<spdifrx_sr::SPDIFRX_SR_SPEC>;
#[doc = "Status register"]
pub mod spdifrx_sr;
#[doc = "SPDIFRX_IFCR (rw) register accessor: an alias for `Reg<SPDIFRX_IFCR_SPEC>`"]
pub type SPDIFRX_IFCR = crate::Reg<spdifrx_ifcr::SPDIFRX_IFCR_SPEC>;
#[doc = "Interrupt flag clear register"]
pub mod spdifrx_ifcr;
#[doc = "SPDIFRX_FMT0_DR (r) register accessor: an alias for `Reg<SPDIFRX_FMT0_DR_SPEC>`"]
...
#[doc = "SPDIFRX_CSR (r) register accessor: an alias for `Reg<SPDIFRX_CSR_SPEC>`"]
pub type SPDIFRX_CSR = crate::Reg<spdifrx_csr::SPDIFRX_CSR_SPEC>;
#[doc = "Channel status register"]
pub mod spdifrx_csr;
#[doc = "SPDIFRX_DIR (r) register accessor: an alias for `Reg<SPDIFRX_DIR_SPEC>`"]
pub type SPDIFRX_DIR = crate::Reg<spdifrx_dir::SPDIFRX_DIR_SPEC>;
#[doc = "Debug information register"]
pub mod spdifrx_dir;
#[doc = "SPDIFRX_VERR (r) register accessor: an alias for `Reg<SPDIFRX_VERR_SPEC>`"]
pub type SPDIFRX_VERR = crate::Reg<spdifrx_verr::SPDIFRX_VERR_SPEC>;
#[doc = "SPDIFRX version register"]
pub mod spdifrx_verr;
#[doc = "SPDIFRX_IPIDR (r) register accessor: an alias for `Reg<SPDIFRX_IPIDR_SPEC>`"]
...
#[doc = "SPDIFRX_SIDR (r) register accessor: an alias for `Reg<SPDIFRX_SIDR_SPEC>`"]
