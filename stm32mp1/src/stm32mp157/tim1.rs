...
pub mod tim1_egr;
#[doc = "TIM1_CCMR1ALTERNATE1 (rw) register accessor: an alias for `Reg<TIM1_CCMR1ALTERNATE1_SPEC>`"]
...
#[doc = "TIM1_CCMR2ALTERNATE17 (rw) register accessor: an alias for `Reg<TIM1_CCMR2ALTERNATE17_SPEC>`"]
