...
pub mod tim4_egr;
#[doc = "TIM4_CCMR1ALTERNATE4 (rw) register accessor: an alias for `Reg<TIM4_CCMR1ALTERNATE4_SPEC>`"]
...
#[doc = "TIM4_CCMR2ALTERNATE20 (rw) register accessor: an alias for `Reg<TIM4_CCMR2ALTERNATE20_SPEC>`"]
...
pub mod tim4_arr;
#[doc = "TIM4_RCR (rw) register accessor: an alias for `Reg<TIM4_RCR_SPEC>`"]
...
pub mod tim4_ccr4;
#[doc = "TIM4_BDTR (rw) register accessor: an alias for `Reg<TIM4_BDTR_SPEC>`"]
...
pub mod tim4_dmar;
#[doc = "TIM4_CCMR3 (rw) register accessor: an alias for `Reg<TIM4_CCMR3_SPEC>`"]
...
pub mod tim4_ccmr3;
#[doc = "TIM4_CCR5 (rw) register accessor: an alias for `Reg<TIM4_CCR5_SPEC>`"]
pub type TIM4_CCR5 = crate::Reg<tim4_ccr5::TIM4_CCR5_SPEC>;
#[doc = "TIM4 capture/compare register 5"]
pub mod tim4_ccr5;
#[doc = "TIM4_CCR6 (rw) register accessor: an alias for `Reg<TIM4_CCR6_SPEC>`"]
