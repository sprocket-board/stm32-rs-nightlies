...
pub mod tim2_egr;
#[doc = "TIM2_CCMR1ALTERNATE2 (rw) register accessor: an alias for `Reg<TIM2_CCMR1ALTERNATE2_SPEC>`"]
...
#[doc = "TIM2_CCMR2ALTERNATE18 (rw) register accessor: an alias for `Reg<TIM2_CCMR2ALTERNATE18_SPEC>`"]
...
pub mod tim2_arr;
#[doc = "TIM2_RCR (rw) register accessor: an alias for `Reg<TIM2_RCR_SPEC>`"]
...
pub mod tim2_ccr4;
#[doc = "TIM2_BDTR (rw) register accessor: an alias for `Reg<TIM2_BDTR_SPEC>`"]
...
pub mod tim2_dmar;
#[doc = "TIM2_CCMR3 (rw) register accessor: an alias for `Reg<TIM2_CCMR3_SPEC>`"]
...
pub mod tim2_ccmr3;
#[doc = "TIM2_CCR5 (rw) register accessor: an alias for `Reg<TIM2_CCR5_SPEC>`"]
pub type TIM2_CCR5 = crate::Reg<tim2_ccr5::TIM2_CCR5_SPEC>;
#[doc = "TIM2 capture/compare register 5"]
pub mod tim2_ccr5;
#[doc = "TIM2_CCR6 (rw) register accessor: an alias for `Reg<TIM2_CCR6_SPEC>`"]
