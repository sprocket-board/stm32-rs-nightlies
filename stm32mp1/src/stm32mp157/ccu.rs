...
#[doc = "FCCAN_CCU_CREL (r) register accessor: an alias for `Reg<FCCAN_CCU_CREL_SPEC>`"]
...
#[doc = "FCCAN_CCU_CCFG (rw) register accessor: an alias for `Reg<FCCAN_CCU_CCFG_SPEC>`"]
...
#[doc = "FCCAN_CCU_CSTAT (r) register accessor: an alias for `Reg<FCCAN_CCU_CSTAT_SPEC>`"]
...
#[doc = "FCCAN_CCU_CWD (rw) register accessor: an alias for `Reg<FCCAN_CCU_CWD_SPEC>`"]
...
#[doc = "FCCAN_CCU_IR (rw) register accessor: an alias for `Reg<FCCAN_CCU_IR_SPEC>`"]
...
#[doc = "FCCAN_CCU_IE (rw) register accessor: an alias for `Reg<FCCAN_CCU_IE_SPEC>`"]
