...
pub mod tim5_egr;
#[doc = "TIM5_CCMR1ALTERNATE5 (rw) register accessor: an alias for `Reg<TIM5_CCMR1ALTERNATE5_SPEC>`"]
...
#[doc = "TIM5_CCMR2ALTERNATE21 (rw) register accessor: an alias for `Reg<TIM5_CCMR2ALTERNATE21_SPEC>`"]
...
pub mod tim5_arr;
#[doc = "TIM5_RCR (rw) register accessor: an alias for `Reg<TIM5_RCR_SPEC>`"]
...
pub mod tim5_ccr4;
#[doc = "TIM5_BDTR (rw) register accessor: an alias for `Reg<TIM5_BDTR_SPEC>`"]
...
pub mod tim5_dmar;
#[doc = "TIM5_CCMR3 (rw) register accessor: an alias for `Reg<TIM5_CCMR3_SPEC>`"]
...
pub mod tim5_ccmr3;
#[doc = "TIM5_CCR5 (rw) register accessor: an alias for `Reg<TIM5_CCR5_SPEC>`"]
pub type TIM5_CCR5 = crate::Reg<tim5_ccr5::TIM5_CCR5_SPEC>;
#[doc = "TIM5 capture/compare register 5"]
pub mod tim5_ccr5;
#[doc = "TIM5_CCR6 (rw) register accessor: an alias for `Reg<TIM5_CCR6_SPEC>`"]
