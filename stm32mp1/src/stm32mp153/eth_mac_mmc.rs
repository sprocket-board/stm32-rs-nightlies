...
pub mod eth_macivir;
#[doc = "ETH_MACQ0TxFCR (rw) register accessor: an alias for `Reg<ETH_MACQ0TX_FCR_SPEC>`"]
...
#[doc = "ETH_MACRxFCR (rw) register accessor: an alias for `Reg<ETH_MACRX_FCR_SPEC>`"]
...
#[doc = "ETH_MACTxQPMR (r) register accessor: an alias for `Reg<ETH_MACTX_QPMR_SPEC>`"]
...
#[doc = "ETH_MACRxQC0R (rw) register accessor: an alias for `Reg<ETH_MACRX_QC0R_SPEC>`"]
...
#[doc = "ETH_MACRxQC1R (rw) register accessor: an alias for `Reg<ETH_MACRX_QC1R_SPEC>`"]
...
#[doc = "ETH_MACRxQC2R (rw) register accessor: an alias for `Reg<ETH_MACRX_QC2R_SPEC>`"]
...
#[doc = "ETH_MACISR (r) register accessor: an alias for `Reg<ETH_MACISR_SPEC>`"]
...
pub mod eth_macier;
#[doc = "ETH_MACRxTxSR (r) register accessor: an alias for `Reg<ETH_MACRX_TX_SR_SPEC>`"]
...
#[doc = "ETH_MACPHYCSR (rw) register accessor: an alias for `Reg<ETH_MACPHYCSR_SPEC>`"]
...
#[doc = "ETH_MACL3A20 (rw) register accessor: an alias for `Reg<ETH_MACL3A20_SPEC>`"]
...
#[doc = "ETH_MACL3A30 (rw) register accessor: an alias for `Reg<ETH_MACL3A30_SPEC>`"]
...
pub mod eth_mactsar;
#[doc = "ETH_MACTSSR (r) register accessor: an alias for `Reg<ETH_MACTSSR_SPEC>`"]
...
gets cleared when the application reads this register."]
pub mod eth_mactssr;
#[doc = "ETH_MACTxTSSNR (r) register accessor: an alias for `Reg<ETH_MACTX_TSSNR_SPEC>`"]
...
#[doc = "ETH_MACTxTSSSR (r) register accessor: an alias for `Reg<ETH_MACTX_TSSSR_SPEC>`"]
