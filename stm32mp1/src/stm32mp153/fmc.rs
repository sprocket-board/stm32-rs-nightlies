...
pub mod fmc_pcr;
#[doc = "FMC_SR (r) register accessor: an alias for `Reg<FMC_SR_SPEC>`"]
...
pub mod fmc_patt;
#[doc = "FMC_HPR (r) register accessor: an alias for `Reg<FMC_HPR_SPEC>`"]
...
pub mod fmc_hpr;
#[doc = "FMC_HECCR (r) register accessor: an alias for `Reg<FMC_HECCR_SPEC>`"]
...
#[doc = "This register contains the control information of each memory bank. It is used for SRAMs, FRAMs, PSRAMs and NOR Flash memories. When the EXTMOD bit is set in the FMC_BCRx register, then this register is active for write access."]
pub mod fmc_bwtr4;
#[doc = "FMC_CSQCR (w) register accessor: an alias for `Reg<FMC_CSQCR_SPEC>`"]
pub type FMC_CSQCR = crate::Reg<fmc_csqcr::FMC_CSQCR_SPEC>;
#[doc = "FMC NAND Command Sequencer Control Register"]
pub mod fmc_csqcr;
#[doc = "FMC_CSQCFGR1 (rw) register accessor: an alias for `Reg<FMC_CSQCFGR1_SPEC>`"]
...
#[doc = "FMC_CSQCFGR2 (rw) register accessor: an alias for `Reg<FMC_CSQCFGR2_SPEC>`"]
...
#[doc = "FMC_CSQCFGR3 (rw) register accessor: an alias for `Reg<FMC_CSQCFGR3_SPEC>`"]
...
#[doc = "FMC_CSQAR1 (rw) register accessor: an alias for `Reg<FMC_CSQAR1_SPEC>`"]
...
pub mod fmc_csqar1;
#[doc = "FMC_CSQAR2 (rw) register accessor: an alias for `Reg<FMC_CSQAR2_SPEC>`"]
...
pub mod fmc_csqemsr;
#[doc = "FMC_BCHIER (rw) register accessor: an alias for `Reg<FMC_BCHIER_SPEC>`"]
pub type FMC_BCHIER = crate::Reg<fmc_bchier::FMC_BCHIER_SPEC>;
#[doc = "FMC BCH Interrupt enable register"]
pub mod fmc_bchier;
#[doc = "FMC_BCHISR (r) register accessor: an alias for `Reg<FMC_BCHISR_SPEC>`"]
...
pub mod fmc_bchisr;
#[doc = "FMC_BCHICR (w) register accessor: an alias for `Reg<FMC_BCHICR_SPEC>`"]
pub type FMC_BCHICR = crate::Reg<fmc_bchicr::FMC_BCHICR_SPEC>;
#[doc = "FMC BCH Interrupt Clear Register"]
pub mod fmc_bchicr;
#[doc = "FMC_BCHPBR1 (r) register accessor: an alias for `Reg<FMC_BCHPBR1_SPEC>`"]
...
pub mod fmc_bchdsr0;
#[doc = "FMC_BCHDSR1 (r) register accessor: an alias for `Reg<FMC_BCHDSR1_SPEC>`"]
...
pub mod fmc_bchdsr1;
#[doc = "FMC_BCHDSR2 (r) register accessor: an alias for `Reg<FMC_BCHDSR2_SPEC>`"]
...
pub mod fmc_bchdsr2;
#[doc = "FMC_BCHDSR3 (r) register accessor: an alias for `Reg<FMC_BCHDSR3_SPEC>`"]
pub type FMC_BCHDSR3 = crate::Reg<fmc_bchdsr3::FMC_BCHDSR3_SPEC>;
#[doc = "The maximum error correction capability of the BCH block embedded in the FMC is 8 errors."]
pub mod fmc_bchdsr3;
#[doc = "FMC_BCHDSR4 (r) register accessor: an alias for `Reg<FMC_BCHDSR4_SPEC>`"]
