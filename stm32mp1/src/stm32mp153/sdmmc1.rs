...
#[doc = "SDMMC_VERR (r) register accessor: an alias for `Reg<SDMMC_VERR_SPEC>`"]
pub type SDMMC_VERR = crate::Reg<sdmmc_verr::SDMMC_VERR_SPEC>;
#[doc = "SDMMC version register"]
pub mod sdmmc_verr;
#[doc = "SDMMC_IPIDR (r) register accessor: an alias for `Reg<SDMMC_IPIDR_SPEC>`"]
pub type SDMMC_IPIDR = crate::Reg<sdmmc_ipidr::SDMMC_IPIDR_SPEC>;
#[doc = "SDMMC identification register"]
pub mod sdmmc_ipidr;
#[doc = "SDMMC_SIDR (r) register accessor: an alias for `Reg<SDMMC_SIDR_SPEC>`"]
