...
#[doc = "TZC_BUILD_CONFIG (r) register accessor: an alias for `Reg<TZC_BUILD_CONFIG_SPEC>`"]
...
#[doc = "TZC_ACTION (rw) register accessor: an alias for `Reg<TZC_ACTION_SPEC>`"]
...
pub mod tzc_action;
#[doc = "TZC_GATE_KEEPER (rw) register accessor: an alias for `Reg<TZC_GATE_KEEPER_SPEC>`"]
...
#[doc = "TZC_SPECULATION_CTRL (rw) register accessor: an alias for `Reg<TZC_SPECULATION_CTRL_SPEC>`"]
...
#[doc = "TZC_INT_STATUS (r) register accessor: an alias for `Reg<TZC_INT_STATUS_SPEC>`"]
...
#[doc = "TZC_INT_CLEAR (rw) register accessor: an alias for `Reg<TZC_INT_CLEAR_SPEC>`"]
...
#[doc = "TZC_FAIL_CONTROL0 (r) register accessor: an alias for `Reg<TZC_FAIL_CONTROL0_SPEC>`"]
...
#[doc = "TZC_FAIL_ID0 (r) register accessor: an alias for `Reg<TZC_FAIL_ID0_SPEC>`"]
...
#[doc = "TZC_FAIL_CONTROL1 (r) register accessor: an alias for `Reg<TZC_FAIL_CONTROL1_SPEC>`"]
pub type TZC_FAIL_CONTROL1 = crate::Reg<tzc_fail_control1::TZC_FAIL_CONTROL1_SPEC>;
#[doc = "Status information about the first access that failed a region permission check in the associated filter (0 to 1)."]
pub mod tzc_fail_control1;
#[doc = "TZC_FAIL_ID1 (r) register accessor: an alias for `Reg<TZC_FAIL_ID1_SPEC>`"]
pub type TZC_FAIL_ID1 = crate::Reg<tzc_fail_id1::TZC_FAIL_ID1_SPEC>;
#[doc = "Contains the master AXI ARID or AWID of the first access that failed a region permission check in the associated filter unit. This occurs even if the ACTION register is set to not drive the interrupt signal. AXI ID mapping is described in Table4: NSAID definition table (TBD)."]
pub mod tzc_fail_id1;
#[doc = "TZC_REGION_ATTRIBUTE0 (rw) register accessor: an alias for `Reg<TZC_REGION_ATTRIBUTE0_SPEC>`"]
...
#[doc = "TZC_REGION_ATTRIBUTE1 (rw) register accessor: an alias for `Reg<TZC_REGION_ATTRIBUTE1_SPEC>`"]
...
#[doc = "TZC_REGION_ATTRIBUTE2 (rw) register accessor: an alias for `Reg<TZC_REGION_ATTRIBUTE2_SPEC>`"]
pub type TZC_REGION_ATTRIBUTE2 = crate::Reg<tzc_region_attribute2::TZC_REGION_ATTRIBUTE2_SPEC>;
#[doc = "Region x attributes."]
pub mod tzc_region_attribute2;
#[doc = "TZC_REGION_ATTRIBUTE3 (rw) register accessor: an alias for `Reg<TZC_REGION_ATTRIBUTE3_SPEC>`"]
pub type TZC_REGION_ATTRIBUTE3 = crate::Reg<tzc_region_attribute3::TZC_REGION_ATTRIBUTE3_SPEC>;
#[doc = "Region x attributes."]
pub mod tzc_region_attribute3;
#[doc = "TZC_REGION_ATTRIBUTE4 (rw) register accessor: an alias for `Reg<TZC_REGION_ATTRIBUTE4_SPEC>`"]
pub type TZC_REGION_ATTRIBUTE4 = crate::Reg<tzc_region_attribute4::TZC_REGION_ATTRIBUTE4_SPEC>;
#[doc = "Region x attributes."]
pub mod tzc_region_attribute4;
#[doc = "TZC_REGION_ATTRIBUTE5 (rw) register accessor: an alias for `Reg<TZC_REGION_ATTRIBUTE5_SPEC>`"]
pub type TZC_REGION_ATTRIBUTE5 = crate::Reg<tzc_region_attribute5::TZC_REGION_ATTRIBUTE5_SPEC>;
#[doc = "Region x attributes."]
pub mod tzc_region_attribute5;
#[doc = "TZC_REGION_ATTRIBUTE6 (rw) register accessor: an alias for `Reg<TZC_REGION_ATTRIBUTE6_SPEC>`"]
pub type TZC_REGION_ATTRIBUTE6 = crate::Reg<tzc_region_attribute6::TZC_REGION_ATTRIBUTE6_SPEC>;
#[doc = "Region x attributes."]
pub mod tzc_region_attribute6;
#[doc = "TZC_REGION_ATTRIBUTE7 (rw) register accessor: an alias for `Reg<TZC_REGION_ATTRIBUTE7_SPEC>`"]
pub type TZC_REGION_ATTRIBUTE7 = crate::Reg<tzc_region_attribute7::TZC_REGION_ATTRIBUTE7_SPEC>;
#[doc = "Region x attributes."]
pub mod tzc_region_attribute7;
#[doc = "TZC_REGION_ATTRIBUTE8 (rw) register accessor: an alias for `Reg<TZC_REGION_ATTRIBUTE8_SPEC>`"]
pub type TZC_REGION_ATTRIBUTE8 = crate::Reg<tzc_region_attribute8::TZC_REGION_ATTRIBUTE8_SPEC>;
#[doc = "Region x attributes."]
pub mod tzc_region_attribute8;
#[doc = "TZC_PID4 (r) register accessor: an alias for `Reg<TZC_PID4_SPEC>`"]
pub type TZC_PID4 = crate::Reg<tzc_pid4::TZC_PID4_SPEC>;
#[doc = "Peripheral ID 4."]
pub mod tzc_pid4;
#[doc = "TZC_PID5 (r) register accessor: an alias for `Reg<TZC_PID5_SPEC>`"]
pub type TZC_PID5 = crate::Reg<tzc_pid5::TZC_PID5_SPEC>;
#[doc = "Peripheral ID 5."]
pub mod tzc_pid5;
#[doc = "TZC_PID6 (r) register accessor: an alias for `Reg<TZC_PID6_SPEC>`"]
pub type TZC_PID6 = crate::Reg<tzc_pid6::TZC_PID6_SPEC>;
#[doc = "Peripheral ID 6."]
pub mod tzc_pid6;
#[doc = "TZC_PID7 (r) register accessor: an alias for `Reg<TZC_PID7_SPEC>`"]
pub type TZC_PID7 = crate::Reg<tzc_pid7::TZC_PID7_SPEC>;
#[doc = "Peripheral ID 7."]
pub mod tzc_pid7;
#[doc = "TZC_PID0 (r) register accessor: an alias for `Reg<TZC_PID0_SPEC>`"]
pub type TZC_PID0 = crate::Reg<tzc_pid0::TZC_PID0_SPEC>;
#[doc = "Peripheral ID 0."]
pub mod tzc_pid0;
#[doc = "TZC_PID1 (r) register accessor: an alias for `Reg<TZC_PID1_SPEC>`"]
pub type TZC_PID1 = crate::Reg<tzc_pid1::TZC_PID1_SPEC>;
#[doc = "Peripheral ID 1."]
pub mod tzc_pid1;
#[doc = "TZC_PID2 (r) register accessor: an alias for `Reg<TZC_PID2_SPEC>`"]
pub type TZC_PID2 = crate::Reg<tzc_pid2::TZC_PID2_SPEC>;
#[doc = "Peripheral ID 2."]
pub mod tzc_pid2;
#[doc = "TZC_PID3 (r) register accessor: an alias for `Reg<TZC_PID3_SPEC>`"]
pub type TZC_PID3 = crate::Reg<tzc_pid3::TZC_PID3_SPEC>;
#[doc = "Peripheral ID 3."]
pub mod tzc_pid3;
#[doc = "TZC_CID0 (r) register accessor: an alias for `Reg<TZC_CID0_SPEC>`"]
pub type TZC_CID0 = crate::Reg<tzc_cid0::TZC_CID0_SPEC>;
#[doc = "Component ID 0."]
pub mod tzc_cid0;
#[doc = "TZC_CID1 (r) register accessor: an alias for `Reg<TZC_CID1_SPEC>`"]
pub type TZC_CID1 = crate::Reg<tzc_cid1::TZC_CID1_SPEC>;
#[doc = "Component ID 1."]
pub mod tzc_cid1;
#[doc = "TZC_CID2 (r) register accessor: an alias for `Reg<TZC_CID2_SPEC>`"]
pub type TZC_CID2 = crate::Reg<tzc_cid2::TZC_CID2_SPEC>;
#[doc = "Component ID 2."]
pub mod tzc_cid2;
#[doc = "TZC_CID3 (r) register accessor: an alias for `Reg<TZC_CID3_SPEC>`"]
pub type TZC_CID3 = crate::Reg<tzc_cid3::TZC_CID3_SPEC>;
#[doc = "Component ID 3."]
pub mod tzc_cid3;
#[doc = "TZC_FAIL_ADDRESS_LOW0 (r) register accessor: an alias for `Reg<TZC_FAIL_ADDRESS_LOW0_SPEC>`"]
...
#[doc = "TZC_FAIL_ADDRESS_HIGH0 (r) register accessor: an alias for `Reg<TZC_FAIL_ADDRESS_HIGH0_SPEC>`"]
...
#[doc = "TZC_FAIL_ADDRESS_LOW1 (r) register accessor: an alias for `Reg<TZC_FAIL_ADDRESS_LOW1_SPEC>`"]
pub type TZC_FAIL_ADDRESS_LOW1 = crate::Reg<tzc_fail_address_low1::TZC_FAIL_ADDRESS_LOW1_SPEC>;
#[doc = "Address low bits of the first failed access in the associated filter (0 to 1)."]
pub mod tzc_fail_address_low1;
#[doc = "TZC_FAIL_ADDRESS_HIGH1 (r) register accessor: an alias for `Reg<TZC_FAIL_ADDRESS_HIGH1_SPEC>`"]
...
#[doc = "TZC_REGION_BASE_HIGH0 (r) register accessor: an alias for `Reg<TZC_REGION_BASE_HIGH0_SPEC>`"]
...
#[doc = "TZC_REGION_TOP_LOW0 (r) register accessor: an alias for `Reg<TZC_REGION_TOP_LOW0_SPEC>`"]
...
#[doc = "TZC_REGION_TOP_HIGH0 (r) register accessor: an alias for `Reg<TZC_REGION_TOP_HIGH0_SPEC>`"]
...
#[doc = "TZC_REGION_ID_ACCESS0 (rw) register accessor: an alias for `Reg<TZC_REGION_ID_ACCESS0_SPEC>`"]
...
#[doc = "TZC_REGION_BASE_LOW1 (rw) register accessor: an alias for `Reg<TZC_REGION_BASE_LOW1_SPEC>`"]
