...
pub mod c1mr;
#[doc = "C1SCR (w) register accessor: an alias for `Reg<C1SCR_SPEC>`"]
pub type C1SCR = crate::Reg<c1scr::C1SCR_SPEC>;
#[doc = "Status Set or Clear register CPU1"]
pub mod c1scr;
#[doc = "C1TOC2SR (r) register accessor: an alias for `Reg<C1TOC2SR_SPEC>`"]
...
pub mod c2mr;
#[doc = "C2SCR (w) register accessor: an alias for `Reg<C2SCR_SPEC>`"]
